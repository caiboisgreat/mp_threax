...
extern const struct _mp_obj_module_t openamp_module;
#undef MODULE_DEF_OPENAMP
#define MODULE_DEF_OPENAMP { MP_ROM_QSTR(MP_QSTR_openamp), MP_ROM_PTR(&openamp_module) },

extern const struct _mp_obj_module_t mp_module_osTimer;
#undef MODULE_DEF_OSTIMER
#define MODULE_DEF_OSTIMER { MP_ROM_QSTR(MP_QSTR_osTimer), MP_ROM_PTR(&mp_module_osTimer) },
...
extern const struct _mp_obj_module_t mp_module_subsystem;
#undef MODULE_DEF_SUBSYSTEM
#define MODULE_DEF_SUBSYSTEM { MP_ROM_QSTR(MP_QSTR_subsystem), MP_ROM_PTR(&mp_module_subsystem) },
...
extern const struct _mp_obj_module_t mp_module_tftlcd;
#undef MODULE_DEF_TFTLCD
#define MODULE_DEF_TFTLCD { MP_ROM_QSTR(MP_QSTR_tftlcd), MP_ROM_PTR(&mp_module_tftlcd) },
