#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#pragma warning(pop) 
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 36 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
static void module_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    ...
    mp_map_elem_t *elem = mp_map_lookup(&self->globals->map, ((mp_obj_t)((((mp_uint_t)(MP_QSTR___name__)) << 3) | 2)), MP_MAP_LOOKUP);
    if (elem != ((void *)0)) {
...
#line 56 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
static void module_attr(mp_obj_t self_in, qstr attr, mp_obj_t *dest) {
    ...
    if (dest[0] == (((mp_obj_t)((void *)0)))) {
        ...
        mp_map_elem_t *elem = mp_map_lookup(&self->globals->map, ((mp_obj_t)((((mp_uint_t)(attr)) << 3) | 2)), MP_MAP_LOOKUP);
        if (elem != ((void *)0)) {
            dest[0] = elem->value;
        
        } else if (attr == MP_QSTR___dict__) {
            dest[0] = ((mp_obj_t)(self->globals));
        #line 73 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
        
        } else if (attr != MP_QSTR___getattr__) {
            elem = mp_map_lookup(&self->globals->map, ((mp_obj_t)((((mp_uint_t)(MP_QSTR___getattr__)) << 3) | 2)), MP_MAP_LOOKUP);
            if (elem != ((void *)0)) {
                dest[0] = mp_call_function_1(elem->value, ((mp_obj_t)((((mp_uint_t)(attr)) << 3) | 2)));
            } else {
                module_attr_try_delegation(self_in, attr, dest);
            }
        #line 82 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
        } else {
            module_attr_try_delegation(self_in, attr, dest);
        }
    } else {
...
#line 97 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
            {
        ...
        if (dest[1] == (((mp_obj_t)((void *)0)))) {
            ...
            mp_obj_dict_delete(((mp_obj_t)(dict)), ((mp_obj_t)((((mp_uint_t)(attr)) << 3) | 2)));
        } else {
            
            mp_obj_dict_store(((mp_obj_t)(dict)), ((mp_obj_t)((((mp_uint_t)(attr)) << 3) | 2)), dest[1]);
        }
        dest[0] = (((mp_obj_t)((void *)0))); 
    }
}

const mp_obj_type_t mp_type_module = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_module, .slot_index_print = 1, .slot_index_attr = 2, .slots = { module_print, module_attr, } };
#line 121 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"

mp_obj_t mp_obj_new_module(qstr module_name) {
    mp_map_t *mp_loaded_modules_map = &(mp_state_ctx.vm.mp_loaded_modules_dict).map;
    mp_map_elem_t *el = mp_map_lookup(mp_loaded_modules_map, ((mp_obj_t)((((mp_uint_t)(module_name)) << 3) | 2)), MP_MAP_LOOKUP_ADD_IF_NOT_FOUND);
    ...
    mp_module_context_t *o = (((mp_module_context_t *)(m_malloc(sizeof(mp_module_context_t) * (1)))));
    o->module.base.type = &mp_type_module;
    o->module.globals = ((void *)(mp_obj_new_dict((1))));

    
    mp_obj_dict_store(((mp_obj_t)(o->module.globals)), ((mp_obj_t)((((mp_uint_t)(MP_QSTR___name__)) << 3) | 2)), ((mp_obj_t)((((mp_uint_t)(module_name)) << 3) | 2)));
...
#line 162 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 174 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 181 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
    const mp_map_t *map = &mp_builtin_module_map;
    #line 183 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
    mp_map_elem_t *elem = mp_map_lookup((mp_map_t *)map, ((mp_obj_t)((((mp_uint_t)(module_name)) << 3) | 2)), MP_MAP_LOOKUP);
...
#line 193 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 217 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 233 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
...
#line 248 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
    (void)self_in;
    (void)attr;
    (void)dest;
    #line 252 "E:\\Work\\code\\opensource\\micropython\\py\\objmodule.c"
}
