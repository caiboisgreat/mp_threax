#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#pragma warning(pop) 
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 36 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 37 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 38 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
size_t mp_binary_get_size(char struct_type, char val_type, size_t *palign) {
    ...
    switch (struct_type) {
        ...
        case '>':
            switch (val_type) {
                ...
                case 'S':
                    size = sizeof(void *);
                    break;
                #line 79 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
                case 'e':
                    size = 2;
                    break;
                case 'f':
        ...
        case '@': {
            ...
            switch (val_type) {
                ...
                case 'l':
                case 'L':
                    align = __alignof(long);
                    size = sizeof(long);
                    break;
                case 'q':
                case 'Q':
                    align = __alignof(long long);
                ...
                case 'S':
                    ...
                    size = sizeof(void *);
                    break;
                #line 132 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
                case 'e':
                    align = 2;
                    size = 2;
                    break;
    ...
    if (size == 0) {
        mp_raise_ValueError((mp_rom_error_text_t)"bad typecode");
    }
...
#line 177 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
#line 250 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
mp_obj_t mp_binary_get_val_array(char typecode, void *p, size_t index) {
    ...
    switch (typecode) {
        ...
        #line 281 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        
        case 'f':
            return mp_obj_new_float_from_f(((float *)p)[index]);
        case 'd':
            return mp_obj_new_float_from_d(((double *)p)[index]);
        #line 287 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        ...
        #line 295 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
    }
    return ((mp_obj_t)((((mp_uint_t)(val)) << 1) | 1));
}
...
mp_obj_t mp_binary_get_val(char struct_type, char val_type, byte *p_base, byte **ptr) {
    ...
    if (struct_type == '@') {
        ...
        p = p_base + (uintptr_t)(void *)(((uintptr_t)(p - p_base) + ((align) - 1)) & ~((align) - 1));
        
        struct_type = '<';
        

#line 338 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
    }
    *ptr = p + size;

    long long val = mp_binary_get_int(size, (val_type > 'Z'), (struct_type == '>'), p);

    if ((1) && val_type == 'O') {
        return (mp_obj_t)(mp_uint_t)val;
    } else if ((1) && val_type == 'S') {
    ...
    #line 364 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
    } else if ((val_type > 'Z')) {
        if ((long long)((mp_int_t)(((mp_int_t)(((mp_uint_t)1) << ((sizeof(mp_uint_t)) * (8) - 1))) >> 1)) <= val && val <= (long long)((mp_int_t)(~(((mp_int_t)(((mp_int_t)(((mp_uint_t)1) << ((sizeof(mp_uint_t)) * (8) - 1))) >> 1)))))) {
            return mp_obj_new_int((mp_int_t)val);
        } else {
            return mp_obj_new_int_from_ll(val);
        }
    } else {
        if ((unsigned long long)val <= (unsigned long long)((mp_int_t)(~(((mp_int_t)(((mp_int_t)(((mp_uint_t)1) << ((sizeof(mp_uint_t)) * (8) - 1))) >> 1)))))) {
    ...
    *ptr = p + size;
    ...
    switch (val_type) {
        ...
        case 'O':
            ...
            break;
        #line 421 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        ...
        case 'd': {
            ...
            if ((sizeof(mp_uint_t)) == 8) {
                val = fp_dp.i64;
            } else {
                int be = struct_type == '>';
                mp_binary_set_int(sizeof(uint32_t), be, p, fp_dp.i32[(!(1)) ^ be]);
                p += sizeof(uint32_t);
                val = fp_dp.i32[(1) ^ be];
            }
            break;
        }
        #line 452 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        default:
            
            if ((mp_obj_is_obj(val_in) && (((mp_obj_base_t *)((void *)(val_in)))->type == (&mp_type_int)))) {
                mp_obj_int_to_bytes_impl(val_in, struct_type == '>', size, p);
                return;
            }
            #line 459 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"

            val = mp_obj_get_int(val_in);
            
            if ((sizeof(mp_uint_t)) < 8 && size > sizeof(val)) {
    ...
    mp_binary_set_int((((size_t)size) < (sizeof(val)) ? ((size_t)size) : (sizeof(val))), struct_type == '>', p, val);
}
...
void mp_binary_set_val_array(char typecode, void *p, size_t index, mp_obj_t val_in) {
    switch (typecode) {
        ...
        case 'd':
            ...
            break;
        #line 485 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        
        
        case 'O':
            ((mp_obj_t *)p)[index] = val_in;
            break;
        #line 491 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        default:
            
            if ((mp_obj_is_obj(val_in) && (((mp_obj_base_t *)((void *)(val_in)))->type == (&mp_type_int)))) {
                size_t size = mp_binary_get_size('@', typecode, ((void *)0));
                mp_obj_int_to_bytes_impl(val_in, (!(1)),
                    size, (uint8_t *)p + index * size);
                return;
            }
            #line 500 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
...
void mp_binary_set_val_array_from_int(char typecode, void *p, size_t index, mp_int_t val) {
    switch (typecode) {
        ...
        case 'Q':
            ...
            break;
        #line 539 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
        ...
        case 'd':
            ...
            break;
        #line 547 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
            
        
        case 'P':
            ((void **)p)[index] = (void *)(uintptr_t)val;
            break;
        #line 553 "E:\\Work\\code\\opensource\\micropython\\py\\binary.c"
    }
}
