#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objgetitemiter.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objgetitemiter.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objgetitemiter.c"
...
static mp_obj_t it_iternext(mp_obj_t self_in) {
    ...
    if ((nlr_push_tail(&nlr), _setjmp((&nlr)->jmpbuf)) == 0) {
        ...
        self->args[2] = ((mp_obj_t)((((mp_uint_t)((((mp_int_t)(self->args[2])) >> 1) + 1)) << 1) | 1));
        nlr_pop();
        return value;
    } else {
...
static const mp_obj_type_t mp_type_it = { .base = { &mp_type_type }, .flags = (0x0080), .name = MP_QSTR_iterator, .slot_index_iter = 1, .slots = { it_iternext, } };
#line 65 "E:\\Work\\code\\opensource\\micropython\\py\\objgetitemiter.c"


mp_obj_t mp_obj_new_getitem_iter(mp_obj_t *args, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_getitem_iter_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_getitem_iter_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objgetitemiter.c", (unsigned)(68)), 0)) );
    mp_obj_getitem_iter_t *o = (mp_obj_getitem_iter_t *)iter_buf;
    o->base.type = &mp_type_it;
    o->args[0] = args[0];
    o->args[1] = args[1];
    o->args[2] = ((mp_obj_t)((((mp_uint_t)(0)) << 1) | 1));
    return ((mp_obj_t)(o));
}
