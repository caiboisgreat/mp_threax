#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"

#line 1 "E:\\Work\\code\\opensource\\micropython\\py/parsenumbase.h"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py/parsenumbase.h"
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 38 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
#line 39 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"

static __declspec(noreturn) void raise_exc(mp_obj_t exc, mp_lexer_t *lex) {
    
    
    if (lex != ((void *)0)) {
        ((mp_obj_base_t *)((void *)(exc)))->type = &mp_type_SyntaxError;
...
#line 70 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"

mp_obj_t mp_parse_num_integer(const char * str_, size_t len, int base, mp_lexer_t *lex) {
    const byte * str = (const byte *)str_;
    const byte * top = str + len;
    _Bool neg = 0;
    mp_obj_t ret_val;
    ...
    if ((base != 0 && base < 2) || base > 36) {
        ...
        mp_raise_ValueError((mp_rom_error_text_t)"int() arg 2 must be >= 2 and <= 36");
    }
    ...
    for (; str < top; str++) {
        ...
        if (mp_mul_mp_int_t_overflow(parsed_val, base, &parsed_val)) {
            goto overflow;
        }
        parsed_val += dig;
        if (!((((parsed_val) ^ ((mp_uint_t)(parsed_val) << 1)) & (((mp_uint_t)1) << ((sizeof(mp_uint_t)) * (8) - 1))) == 0)) {
            goto overflow;
        }
    }
    ...
    ret_val = ((mp_obj_t)((((mp_uint_t)(neg ? (-parsed_val) : parsed_val)) << 1) | 1));
have_ret_val:
...
#line 148 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 178 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 186 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"



#line 190 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
        vstr_t vstr;
        mp_print_t print;
        ...
        raise_exc(exc, lex);
        #line 199 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
    }
}
...
#line 223 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"

#line 225 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
...
#line 264 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
    ...
    #line 282 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
}
...
static mp_large_float_uint_t accept_digit(mp_large_float_uint_t p_mantissa, unsigned int dig, int *p_exp_extra, int in) {
    ...
    if (p_mantissa < (sizeof(mp_large_float_uint_t) == 8 ? 0x1999999999999998ULL : 0x19999998U)) {
    ...
    while (str < top) {
        ...
        if ('0' <= dig && dig <= '9') {
            ...
            if (in == PARSE_DEC_IN_EXP) {
                ...
                if (exp_val < (2147483647 / 2 - 9) / 10) {
                    exp_val = 10 * exp_val + dig;
                }
            } else {
                if (dig == 0 || mantissa >= (sizeof(mp_large_float_uint_t) == 8 ? 0x1999999999999998ULL : 0x19999998U)) {
...
#line 383 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"


mp_obj_t mp_parse_num_decimal(const char *str, size_t len, _Bool allow_imag, _Bool force_complex, mp_lexer_t *lex)


#line 389 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
{
...
parse_start:;
    #line 400 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
    _Bool dec_neg = 0;
    ...
    if (str + 2 < top && (str[0] | 0x20) == 'i' && (str[1] | 0x20) == 'n' && (str[2] | 0x20) == 'f') {
        ...
        str += 3;
        dec_val = (mp_float_t)((float)(1e+300));
...
#line 450 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
    }
    ...
    if (str != top) {
        ...
        #line 477 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
        goto value_error;
    }
    ...
    #line 486 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
    ...
    #line 496 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"

    return mp_obj_new_float(dec_val);

value_error:
    raise_exc(mp_obj_new_exception_msg(&mp_type_ValueError, (mp_rom_error_text_t)"invalid syntax for number"), lex);

    

#line 505 "E:\\Work\\code\\opensource\\micropython\\py\\parsenum.c"
}
