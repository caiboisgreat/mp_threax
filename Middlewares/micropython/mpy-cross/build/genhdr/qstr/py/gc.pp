#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/gc.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/gc.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/mpprint.h"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py/gc.h"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"



#line 38 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 45 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"


#line 48 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 84 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

#line 86 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 114 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"





#line 120 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"




#line 125 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 132 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
static void gc_mark_subtree(size_t block);
#line 134 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 155 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    area->gc_alloc_table_byte_len = (total_byte_len - (1)) / (1 + (8) / 2 * ((4 * (sizeof(mp_uint_t)))));
    #line 157 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 164 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    size_t gc_pool_block_len = area->gc_alloc_table_byte_len * (4);
    area->gc_pool_start = (byte *)end - gc_pool_block_len * ((4 * (sizeof(mp_uint_t))));
    area->gc_pool_end = end;

    

#line 172 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    


#line 177 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    
    memset(area->gc_alloc_table_start, 0, area->gc_alloc_table_byte_len + (1));
    #line 180 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 187 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    (void)0;
    (void)0;
#line 193 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    




#line 199 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    (void)0;
#line 202 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
}

void gc_init(void *start, void *end) {
    
    end = (void *)((uintptr_t)end & (~(((4 * (sizeof(mp_uint_t)))) - 1)));
    (void)0;

    gc_setup_area(&(mp_state_ctx.mem.area), start, end);

    
    

#line 215 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    
    (mp_state_ctx.thread.gc_lock_depth) = 0;
    ...
    (mp_state_ctx.mem.gc_alloc_threshold) = (size_t)-1;
    (mp_state_ctx.mem.gc_alloc_amount) = 0;
    #line 227 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 344 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
void gc_lock(void) {
    ...
    (mp_state_ctx.thread.gc_lock_depth) += (1 << 0);
}
...
_Bool gc_is_locked(void) {
    return (mp_state_ctx.thread.gc_lock_depth) != 0;
}
...
#line 378 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 390 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

#line 392 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
#line 393 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

void gc_collect_start(void) {
    gc_collect_start_common();
    
    (mp_state_ctx.mem.gc_alloc_amount) = 0;
    #line 399 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    
    
    
    void **ptrs = (void **)(void *)&mp_state_ctx;
    size_t root_start = ((size_t)&(((mp_state_ctx_t*)0)->thread.dict_locals));
    size_t root_end = ((size_t)&(((mp_state_ctx_t*)0)->vm.qstr_last_chunk));
...
#line 413 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
}

static void gc_collect_start_common(void) {
    ;
    ((void)( (!!(((mp_state_ctx.thread.gc_lock_depth) & 0) == 0)) || (_wassert(L"(MP_STATE_THREAD(gc_lock_depth) & GC_COLLECT_FLAG) == 0", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(417)), 0)) );
    (mp_state_ctx.thread.gc_lock_depth) |= 0;
    (mp_state_ctx.mem.gc_stack_overflow) = 0;
}

void gc_collect_root(void **ptrs, size_t len) {
    
    mp_state_mem_area_t *area = &(mp_state_ctx.mem.area);
    #line 426 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 435 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        if (!( ((uintptr_t)(ptr) & (((4 * (sizeof(mp_uint_t)))) - 1)) == 0 && ptr >= (void *)(mp_state_ctx.mem.area).gc_pool_start && ptr < (void *)(mp_state_ctx.mem.area).gc_pool_end )) {
            continue;
        }
        #line 439 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        size_t block = (((byte *)(ptr) - area->gc_pool_start) / ((4 * (sizeof(mp_uint_t)))));
        if ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (1)) {
            
            do { area->gc_alloc_table_start[(block) / (4)] |= ((3) << (2 * ((block) & ((4) - 1)))); } while (0);
            

#line 446 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
            gc_mark_subtree(block);
            #line 448 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        }
    }
}
...
#line 459 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
static void gc_mark_subtree(size_t block)
#line 461 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
{
    ...
    for (;;) {
        ...
        mp_state_mem_area_t *area = &(mp_state_ctx.mem.area);
        #line 468 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

        
        size_t n_blocks = 0;
        do {
            n_blocks += 1;
        } while ((((area)->gc_alloc_table_start[(block + n_blocks) / (4)] >> (2 * ((block + n_blocks) & ((4) - 1)))) & 3) == (2));

        
        ((void)( (!!(area->gc_pool_start + (block + n_blocks) * ((4 * (sizeof(mp_uint_t)))) <= area->gc_pool_end)) || (_wassert(L"area->gc_pool_start + (block + n_blocks) * BYTES_PER_BLOCK <= area->gc_pool_end", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(476)), 0)) );

        
        void **ptrs = (void **)(((block) * ((4 * (sizeof(mp_uint_t)))) + (uintptr_t)area->gc_pool_start));
        for (size_t i = n_blocks * ((4 * (sizeof(mp_uint_t)))) / sizeof(void *); i > 0; i--, ptrs++) {
            ;
            void *ptr = *ptrs;
...
#line 492 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
            if (!( ((uintptr_t)(ptr) & (((4 * (sizeof(mp_uint_t)))) - 1)) == 0 && ptr >= (void *)(mp_state_ctx.mem.area).gc_pool_start && ptr < (void *)(mp_state_ctx.mem.area).gc_pool_end )) {
                continue;
            }
            mp_state_mem_area_t *ptr_area = area;
            #line 497 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
            size_t ptr_block = (((byte *)(ptr) - ptr_area->gc_pool_start) / ((4 * (sizeof(mp_uint_t)))));
            if ((((ptr_area)->gc_alloc_table_start[(ptr_block) / (4)] >> (2 * ((ptr_block) & ((4) - 1)))) & 3) != (1)) {
                
                continue;
            }
            
            ;
            do { ptr_area->gc_alloc_table_start[(ptr_block) / (4)] |= ((3) << (2 * ((ptr_block) & ((4) - 1)))); } while (0);
            if (sp < (64)) {
                (mp_state_ctx.mem.gc_block_stack)[sp] = ptr_block;
                

#line 510 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                sp += 1;
            } else {
                (mp_state_ctx.mem.gc_stack_overflow) = 1;
            }
        }
        ...
        sp -= 1;
        block = (mp_state_ctx.mem.gc_block_stack)[sp];
        

#line 527 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    }
}
...
#line 542 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    for (mp_state_mem_area_t *area = &(mp_state_ctx.mem.area); area != ((void *)0); area = (((void *)0))) {
        area->gc_last_free_atb_index = 0;
    }
    (mp_state_ctx.thread.gc_lock_depth) &= ~0;
    ;
...
static void gc_deal_with_stack_overflow(void) {
    while ((mp_state_ctx.mem.gc_stack_overflow)) {
        (mp_state_ctx.mem.gc_stack_overflow) = 0;

        
        for (mp_state_mem_area_t *area = &(mp_state_ctx.mem.area); area != ((void *)0); area = (((void *)0))) {
            for (size_t block = 0; block < area->gc_alloc_table_byte_len * (4); block++) {
                ;
                
                if ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (3)) {
                    

#line 562 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                    gc_mark_subtree(block);
                    #line 564 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                }
            }
        }
    }
...
#line 610 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
}
...
#line 617 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    int free_tail = 0;
    

#line 621 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    for (mp_state_mem_area_t *area = &(mp_state_ctx.mem.area); area != ((void *)0); area = (((void *)0))) {
        size_t last_used_block = 0;
        ((void)( (!!(area->gc_last_used_block <= area->gc_alloc_table_byte_len * (4))) || (_wassert(L"area->gc_last_used_block <= area->gc_alloc_table_byte_len * BLOCKS_PER_ATB", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(624)), 0)) );

        for (size_t block = 0; block <= area->gc_last_used_block; block++) {
            ;
            switch ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3)) {
                case (1):
                    free_tail = 1;
                    (void)0;
                    

#line 635 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 644 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                    } else {
                ...
                case (3):
                    do { area->gc_alloc_table_start[(block) / (4)] &= (~((2) << (2 * ((block) & ((4) - 1))))); } while (0);
                    free_tail = 0;
                    last_used_block = block;
                    break;
            }
...
#line 669 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    }
}
...
#line 678 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
static void *gc_get_ptr(void **ptrs, int i) {
    



#line 684 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    return ptrs[i];
}
...
void gc_info(gc_info_t *info) {
    ...
    for (mp_state_mem_area_t *area = &(mp_state_ctx.mem.area); area != ((void *)0); area = (((void *)0))) {
        ...
        for (size_t block = 0, len = 0, len_free = 0; !finish;) {
            ;
            size_t kind = (((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3);
            switch (kind) {
                case (0):
                    info->free += 1;
                    len_free += 1;
            ...
            block++;
            finish = (block == area->gc_alloc_table_byte_len * (4));
            
            if (!finish) {
                kind = (((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3);
            }

            if (finish || kind == (0) || kind == (1)) {
                if (len == 1) {
                    info->num_1block += 1;
                } else if (len == 2) {
                    info->num_2block += 1;
    ...
    info->used *= ((4 * (sizeof(mp_uint_t))));
    info->free *= ((4 * (sizeof(mp_uint_t))));

    

#line 756 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    ;
}

void *gc_alloc(size_t n_bytes, unsigned int alloc_flags) {
    _Bool has_finaliser = alloc_flags & GC_ALLOC_FLAG_HAS_FINALISER;
    size_t n_blocks = ((n_bytes + ((4 * (sizeof(mp_uint_t)))) - 1) & (~(((4 * (sizeof(mp_uint_t)))) - 1))) / ((4 * (sizeof(mp_uint_t))));
    (void)0;
    ...
    if ((mp_state_ctx.thread.gc_lock_depth) > 0) {
        return ((void *)0);
    }
    ...
    size_t start_block;
    size_t n_free;
    int collected = !(mp_state_ctx.mem.gc_auto_collect_enabled);
    

#line 786 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    
    if (!collected && (mp_state_ctx.mem.gc_alloc_amount) >= (mp_state_ctx.mem.gc_alloc_threshold)) {
        ;
        gc_collect();
        collected = 1;
        ;
    }
    #line 795 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    for (;;) {

        

#line 801 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        area = &(mp_state_ctx.mem.area);
        #line 803 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

        
        for (; area != ((void *)0); area = (((void *)0)), i = 0) {
            n_free = 0;
            for (i = area->gc_last_free_atb_index; i < area->gc_alloc_table_byte_len; i++) {
                ;
                byte a = area->gc_alloc_table_start[i];
                
                if ((((a) & (0x03)) == 0)) { if (++n_free >= n_blocks) { i = i * (4) + 0; goto found; } } else { n_free = 0; }
                if ((((a) & (0x0c)) == 0)) { if (++n_free >= n_blocks) { i = i * (4) + 1; goto found; } } else { n_free = 0; }
                if ((((a) & (0x30)) == 0)) { if (++n_free >= n_blocks) { i = i * (4) + 2; goto found; } } else { n_free = 0; }
                if ((((a) & (0xc0)) == 0)) { if (++n_free >= n_blocks) { i = i * (4) + 3; goto found; } } else { n_free = 0; }
...
#line 826 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        }
...
#line 837 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
            return ((void *)0);
        }
        (void)0;
        gc_collect();
...
#line 860 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        area->gc_last_free_atb_index = (i + 1) / (4);
    }

    area->gc_last_used_block = ((area->gc_last_used_block) > (end_block) ? (area->gc_last_used_block) : (end_block));

    
    do { area->gc_alloc_table_start[(start_block) / (4)] |= ((1) << (2 * ((start_block) & ((4) - 1)))); } while (0);

    
    
    for (size_t bl = start_block + 1; bl <= end_block; bl++) {
        do { area->gc_alloc_table_start[(bl) / (4)] |= ((2) << (2 * ((bl) & ((4) - 1)))); } while (0);
    }

    
    
    void *ret_ptr = (void *)(area->gc_pool_start + start_block * ((4 * (sizeof(mp_uint_t)))));
    (void)0;

    
    (mp_state_ctx.mem.gc_alloc_amount) += n_blocks;
    #line 882 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    ;

    
    
    memset((byte *)ret_ptr, 0, (end_block - start_block + 1) * ((4 * (sizeof(mp_uint_t)))));
...
#line 896 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 907 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    (void)has_finaliser;
    #line 909 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    

#line 913 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 946 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    ((void)( (!!(( ((uintptr_t)(ptr) & (((4 * (sizeof(mp_uint_t)))) - 1)) == 0 && ptr >= (void *)(mp_state_ctx.mem.area).gc_pool_start && ptr < (void *)(mp_state_ctx.mem.area).gc_pool_end ))) || (_wassert(L"VERIFY_PTR(ptr)", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(946)), 0)) );
    area = &(mp_state_ctx.mem.area);
    #line 949 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    size_t block = (((byte *)(ptr) - area->gc_pool_start) / ((4 * (sizeof(mp_uint_t)))));
    ((void)( (!!((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (1) || ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (3) && ((mp_state_ctx.thread.gc_lock_depth) & 0)))) || (_wassert(L"ATB_GET_KIND(area, block) == AT_HEAD || (ATB_GET_KIND(area, block) == AT_MARK && (MP_STATE_THREAD(gc_lock_depth) & GC_COLLECT_FLAG))", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(952)), 0)) );
#line 953 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    

#line 957 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 972 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

    
    if (block / (4) < area->gc_last_free_atb_index) {
        area->gc_last_free_atb_index = block / (4);
    }
    ...
    do {
        do { area->gc_alloc_table_start[(block) / (4)] &= (~((3) << (2 * ((block) & ((4) - 1))))); } while (0);
        block += 1;
    } while ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (2));

    ;

    

#line 989 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
}
...
#line 998 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    if (( ((uintptr_t)(ptr) & (((4 * (sizeof(mp_uint_t)))) - 1)) == 0 && ptr >= (void *)(mp_state_ctx.mem.area).gc_pool_start && ptr < (void *)(mp_state_ctx.mem.area).gc_pool_end )) {
        area = &(mp_state_ctx.mem.area);
    } else {
        area = ((void *)0);
    }
    #line 1004 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    ...
    if (area) {
        ...
        if ((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (1)) {
            ...
            ;
            return n_blocks * ((4 * (sizeof(mp_uint_t))));
        }
    }
...
void *gc_realloc(void *ptr_in, size_t n_bytes, _Bool allow_move) {
...
#line 1049 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    ((void)( (!!(( ((uintptr_t)(ptr) & (((4 * (sizeof(mp_uint_t)))) - 1)) == 0 && ptr >= (void *)(mp_state_ctx.mem.area).gc_pool_start && ptr < (void *)(mp_state_ctx.mem.area).gc_pool_end ))) || (_wassert(L"VERIFY_PTR(ptr)", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(1049)), 0)) );
    area = &(mp_state_ctx.mem.area);
    #line 1052 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    size_t block = (((byte *)(ptr) - area->gc_pool_start) / ((4 * (sizeof(mp_uint_t)))));
    ((void)( (!!((((area)->gc_alloc_table_start[(block) / (4)] >> (2 * ((block) & ((4) - 1)))) & 3) == (1))) || (_wassert(L"ATB_GET_KIND(area, block) == AT_HEAD", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(1053)), 0)) );

    
    size_t new_blocks = (n_bytes + ((4 * (sizeof(mp_uint_t)))) - 1) / ((4 * (sizeof(mp_uint_t))));
    ...
    size_t n_free = 0;
    size_t n_blocks = 1; 
    size_t max_block = area->gc_alloc_table_byte_len * (4);
    for (size_t bl = block + n_blocks; bl < max_block; bl++) {
        byte block_type = (((area)->gc_alloc_table_start[(bl) / (4)] >> (2 * ((bl) & ((4) - 1)))) & 3);
        if (block_type == (2)) {
            n_blocks++;
            continue;
        }
    ...
    if (new_blocks < n_blocks) {
        ...
        for (size_t bl = block + new_blocks, count = n_blocks - new_blocks; count > 0; bl++, count--) {
            do { area->gc_alloc_table_start[(bl) / (4)] &= (~((3) << (2 * ((bl) & ((4) - 1))))); } while (0);
        }
...
#line 1103 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

        
        if ((block + new_blocks) / (4) < area->gc_last_free_atb_index) {
            area->gc_last_free_atb_index = (block + new_blocks) / (4);
        }
...
#line 1114 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    ...
    if (new_blocks <= n_blocks + n_free) {
        ...
        for (size_t bl = block + n_blocks; bl < end_block; bl++) {
            ((void)( (!!((((area)->gc_alloc_table_start[(bl) / (4)] >> (2 * ((bl) & ((4) - 1)))) & 3) == (0))) || (_wassert(L"ATB_GET_KIND(area, bl) == AT_FREE", L"E:\\Work\\code\\opensource\\micropython\\py\\gc.c", (unsigned)(1123)), 0)) );
            do { area->gc_alloc_table_start[(bl) / (4)] |= ((2) << (2 * ((bl) & ((4) - 1)))); } while (0);
        }
        ...
        memset((byte *)ptr_in + n_blocks * ((4 * (sizeof(mp_uint_t)))), 0, (new_blocks - n_blocks) * ((4 * (sizeof(mp_uint_t)))));
        


#line 1138 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"

        

#line 1142 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 1149 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    _Bool ftb_state = 0;
    #line 1151 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
    ...
    (void)0;
    memcpy(ptr_out, ptr_in, n_blocks * ((4 * (sizeof(mp_uint_t)))));
    gc_free(ptr_in);
    return ptr_out;
}
...
#line 1181 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
void gc_dump_alloc_table(const mp_print_t *print) {
    ...
    for (mp_state_mem_area_t *area = &(mp_state_ctx.mem.area); area != ((void *)0); area = (((void *)0))) {
        ...
        #line 1194 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
        for (size_t bl = 0; bl < area->gc_alloc_table_byte_len * (4); bl++) {
            if (bl % DUMP_BYTES_PER_LINE == 0) {
                
                {
                    
                    size_t bl2 = bl;
                    while (bl2 < area->gc_alloc_table_byte_len * (4) && (((area)->gc_alloc_table_start[(bl2) / (4)] >> (2 * ((bl2) & ((4) - 1)))) & 3) == (0)) {
                        bl2++;
                    }
                    if (bl2 - bl >= 2 * DUMP_BYTES_PER_LINE) {
                        ...
                        if (bl >= area->gc_alloc_table_byte_len * (4)) {
                ...
                mp_printf(print, "\n%08x: ", (uint)(bl * ((4 * (sizeof(mp_uint_t))))));
            }
            int c = ' ';
            switch ((((area)->gc_alloc_table_start[(bl) / (4)] >> (2 * ((bl) & ((4) - 1)))) & 3)) {
                case (0):
                    c = '.';
                    break;
                ...
                case (1): {
                    void **ptr = (void **)(area->gc_pool_start + bl * ((4 * (sizeof(mp_uint_t)))));
                    ...
                    #line 1265 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                    



#line 1270 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                    
                    else if (*ptr == &mp_type_float) {
                        c = 'F';
                    }
                    #line 1275 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
...
#line 1298 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
                    }
                    break;
                }
                case (2):
...
#line 1316 "E:\\Work\\code\\opensource\\micropython\\py\\gc.c"
