#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
#line 1 "E:\\Work\\code\\opensource\\micropython\\ports\\windows\\msvc\\unistd.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\ports\\windows\\msvc\\unistd.h"
...
#line 45 "E:\\Work\\code\\opensource\\micropython\\ports\\windows\\msvc\\unistd.h"
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
mp_off_t mp_stream_seek(mp_obj_t stream, mp_off_t offset, int whence, int *errcode) {
    ...
    const mp_stream_p_t *stream_p = mp_get_stream(stream);
    mp_uint_t res = stream_p->ioctl(((mp_obj_t)(stream)), (2), (mp_uint_t)(uintptr_t)&seek_s, errcode);
    if (res == ((mp_uint_t)-1)) {
        return (mp_off_t)-1;
    }
...
const mp_stream_p_t *mp_get_stream_raise(mp_obj_t self_in, int flags) {
    ...
    if (((type)->slot_index_protocol)) {
        const mp_stream_p_t *stream_p = ((const void *)(type)->slots[(type)->slot_index_protocol - 1]);
        if (!((flags & (1)) && stream_p->read == ((void *)0))
            && !((flags & (2)) && stream_p->write == ((void *)0))
            && !((flags & (4)) && stream_p->ioctl == ((void *)0))) {
            return stream_p;
        }
    }
    
    mp_raise_msg(&mp_type_OSError, (mp_rom_error_text_t)"stream operation not supported");
}
...
static mp_obj_t stream_read_generic(size_t n_args, const mp_obj_t *args, byte flags) {
    ...
    if (stream_p->is_text) {
        ...
        while (more_bytes > 0) {
            ...
            int error;
            mp_uint_t out_sz = mp_stream_rw(args[0], p, more_bytes, &error, 0);
            if (error != 0) {
    ...
    #line 207 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
...
static mp_obj_t stream_read(size_t n_args, const mp_obj_t *args) {
    return stream_read_generic(n_args, args, 0);
}
const mp_obj_fun_builtin_var_t mp_stream_read_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)(2)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_read}};

static mp_obj_t stream_read1(size_t n_args, const mp_obj_t *args) {
    return stream_read_generic(n_args, args, 0 | 1);
}
const mp_obj_fun_builtin_var_t mp_stream_read1_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)(2)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_read1}};
...
mp_obj_t mp_stream_write(mp_obj_t self_in, const void *buf, size_t len, byte flags) {
    ...
    if (error != 0) {
        ...
        return ((mp_obj_t)((((mp_uint_t)(out_sz)) << 1) | 1));
    }
}


void mp_stream_write_adaptor(void *self, const char *buf, size_t len) {
    mp_stream_write(((mp_obj_t)(self)), buf, len, 2);
}

static mp_obj_t stream_readinto_write_generic(size_t n_args, const mp_obj_t *args, byte flags) {
    mp_buffer_info_t bufinfo;
    mp_get_buffer_raise(args[1], &bufinfo, (flags & 2) ? (1) : (2));
    ...
    return mp_stream_write(args[0], (byte *)bufinfo.buf + off, ((bufinfo.len) < (max_len) ? (bufinfo.len) : (max_len)), flags);
}

static mp_obj_t stream_write_method(size_t n_args, const mp_obj_t *args) {
    return stream_readinto_write_generic(n_args, args, 2);
}
const mp_obj_fun_builtin_var_t mp_stream_write_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(4)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_write_method}};

static mp_obj_t stream_write1_method(size_t n_args, const mp_obj_t *args) {
    return stream_readinto_write_generic(n_args, args, 2 | 1);
}
const mp_obj_fun_builtin_var_t mp_stream_write1_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(4)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_write1_method}};

static mp_obj_t stream_readinto(size_t n_args, const mp_obj_t *args) {
    return stream_readinto_write_generic(n_args, args, 0);
}
const mp_obj_fun_builtin_var_t mp_stream_readinto_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_readinto}};

static mp_obj_t stream_readinto1(size_t n_args, const mp_obj_t *args) {
    return stream_readinto_write_generic(n_args, args, 0 | 1);
}
const mp_obj_fun_builtin_var_t mp_stream_readinto1_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_readinto1}};
...
const mp_obj_fun_builtin_var_t mp_stream_unbuffered_readline_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)(2)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_unbuffered_readline}};


static mp_obj_t stream_unbuffered_readlines(mp_obj_t self) {
    mp_obj_t lines = mp_obj_new_list(0, ((void *)0));
    for (;;) {
...
const mp_obj_fun_builtin_fixed_t mp_stream_unbuffered_readlines_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = stream_unbuffered_readlines}};
...
mp_obj_t mp_stream_close(mp_obj_t stream) {
    const mp_stream_p_t *stream_p = mp_get_stream(stream);
    int error;
    mp_uint_t res = stream_p->ioctl(stream, (4), 0, &error);
    if (res == ((mp_uint_t)-1)) {
        mp_raise_OSError(error);
    }
    return ((mp_obj_t)(((0) << 3) | 6));
}
const mp_obj_fun_builtin_fixed_t mp_stream_close_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = mp_stream_close}};

static mp_obj_t mp_stream___exit__(size_t n_args, const mp_obj_t *args) {
    (void)n_args;
    return mp_stream_close(args[0]);
}
const mp_obj_fun_builtin_var_t mp_stream___exit___obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(4)) << 17) | (((uint32_t)(4)) << 1) | ((0) ? 1 : 0))), .fun = {.var = mp_stream___exit__}};
...
const mp_obj_fun_builtin_var_t mp_stream_seek_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_seek}};

static mp_obj_t stream_tell(mp_obj_t self) {
    mp_obj_t offset = ((mp_obj_t)((((mp_uint_t)(0)) << 1) | 1));
    mp_obj_t whence = ((mp_obj_t)((((mp_uint_t)(1)) << 1) | 1));
    const mp_obj_t args[3] = {self, offset, whence};
    return stream_seek(3, args);
}
const mp_obj_fun_builtin_fixed_t mp_stream_tell_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = stream_tell}};

static mp_obj_t stream_flush(mp_obj_t self) {
    const mp_stream_p_t *stream_p = mp_get_stream(self);
    int error;
    mp_uint_t res = stream_p->ioctl(self, (1), 0, &error);
    if (res == ((mp_uint_t)-1)) {
        mp_raise_OSError(error);
    }
    return ((mp_obj_t)(((0) << 3) | 6));
}
const mp_obj_fun_builtin_fixed_t mp_stream_flush_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = stream_flush}};

static mp_obj_t stream_ioctl(size_t n_args, const mp_obj_t *args) {
    mp_buffer_info_t bufinfo;
    uintptr_t val = 0;
    if (n_args > 2) {
        if (mp_get_buffer(args[2], &bufinfo, (2))) {
...
const mp_obj_fun_builtin_var_t mp_stream_ioctl_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = stream_ioctl}};
...
#line 567 "E:\\Work\\code\\opensource\\micropython\\py\\stream.c"
