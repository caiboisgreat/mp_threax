#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/mpstate.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"




#line 1 "E:\\Work\\code\\opensource\\micropython\\py/asmxtensa.h"
...
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/asmbase.h"
...
void mp_asm_base_deinit(mp_asm_base_t *as, _Bool free_code);
...
static __inline void mp_asm_base_suppress_code(mp_asm_base_t *as) {
    as->suppress = 1;
}

static __inline size_t mp_asm_base_get_code_pos(mp_asm_base_t *as) {
    return as->code_offset;
}

static __inline size_t mp_asm_base_get_code_size(mp_asm_base_t *as) {
    return as->code_size;
}

static __inline void *mp_asm_base_get_code(mp_asm_base_t *as) {
    

#line 75 "E:\\Work\\code\\opensource\\micropython\\py/asmbase.h"
    return as->code_base;
    #line 77 "E:\\Work\\code\\opensource\\micropython\\py/asmbase.h"
}

#line 80 "E:\\Work\\code\\opensource\\micropython\\py/asmbase.h"
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/asmxtensa.h"
...
static __inline void asm_xtensa_op_entry(asm_xtensa_t *as, uint reg_src, int32_t num_bytes) {
    asm_xtensa_op24(as, ((((num_bytes / 8) & 0xfff) << 12) | ((reg_src) << 8) | ((0) << 6) | ((3) << 4) | (6)));
}

static __inline void asm_xtensa_op_add_n(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op16(as, (((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (10)));
}

static __inline void asm_xtensa_op_addi(asm_xtensa_t *as, uint reg_dest, uint reg_src, int imm8) {
    asm_xtensa_op24(as, ((((uint32_t)imm8 & 0xff) << 16) | ((12) << 12) | ((reg_src) << 8) | ((reg_dest) << 4) | (2)));
}

static __inline void asm_xtensa_op_addx2(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)9) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_addx4(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)10) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_and(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)1) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_bcc(asm_xtensa_t *as, uint cond, uint reg_src1, uint reg_src2, int32_t rel8) {
    asm_xtensa_op24(as, ((((uint32_t)rel8 & 0xff) << 16) | ((cond) << 12) | ((reg_src1) << 8) | ((reg_src2) << 4) | (7)));
}

static __inline void asm_xtensa_op_bccz(asm_xtensa_t *as, uint cond, uint reg_src, int32_t rel12) {
    asm_xtensa_op24(as, (((rel12 & 0xfff) << 12) | ((reg_src) << 8) | ((cond) << 6) | ((1) << 4) | (6)));
}

static __inline void asm_xtensa_op_call0(asm_xtensa_t *as, int32_t rel18) {
    asm_xtensa_op24(as, (((rel18 & 0x3ffff) << 6) | ((0) << 4) | (5)));
}

static __inline void asm_xtensa_op_callx0(asm_xtensa_t *as, uint reg) {
    asm_xtensa_op24(as, ((((uint32_t)0) << 20) | (((uint32_t)0) << 16) | ((0) << 12) | ((reg) << 8) | ((3) << 6) | ((0) << 4) | (0)));
}

static __inline void asm_xtensa_op_callx8(asm_xtensa_t *as, uint reg) {
    asm_xtensa_op24(as, ((((uint32_t)0) << 20) | (((uint32_t)0) << 16) | ((0) << 12) | ((reg) << 8) | ((3) << 6) | ((2) << 4) | (0)));
}

static __inline void asm_xtensa_op_j(asm_xtensa_t *as, int32_t rel18) {
    asm_xtensa_op24(as, (((rel18 & 0x3ffff) << 6) | ((0) << 4) | (6)));
}

static __inline void asm_xtensa_op_jx(asm_xtensa_t *as, uint reg) {
    asm_xtensa_op24(as, ((((uint32_t)0) << 20) | (((uint32_t)0) << 16) | ((0) << 12) | ((reg) << 8) | ((2) << 6) | ((2) << 4) | (0)));
}

static __inline void asm_xtensa_op_l8ui(asm_xtensa_t *as, uint reg_dest, uint reg_base, uint byte_offset) {
    asm_xtensa_op24(as, ((((uint32_t)byte_offset & 0xff) << 16) | ((0) << 12) | ((reg_base) << 8) | ((reg_dest) << 4) | (2)));
}

static __inline void asm_xtensa_op_l16ui(asm_xtensa_t *as, uint reg_dest, uint reg_base, uint half_word_offset) {
    asm_xtensa_op24(as, ((((uint32_t)half_word_offset & 0xff) << 16) | ((1) << 12) | ((reg_base) << 8) | ((reg_dest) << 4) | (2)));
}

static __inline void asm_xtensa_op_l32i(asm_xtensa_t *as, uint reg_dest, uint reg_base, uint word_offset) {
    asm_xtensa_op24(as, ((((uint32_t)word_offset & 0xff) << 16) | ((2) << 12) | ((reg_base) << 8) | ((reg_dest) << 4) | (2)));
}

static __inline void asm_xtensa_op_l32i_n(asm_xtensa_t *as, uint reg_dest, uint reg_base, uint word_offset) {
    asm_xtensa_op16(as, (((word_offset & 0xf) << 12) | ((reg_base) << 8) | ((reg_dest) << 4) | (8)));
}

static __inline void asm_xtensa_op_l32r(asm_xtensa_t *as, uint reg_dest, uint32_t op_off, uint32_t dest_off) {
    asm_xtensa_op24(as, (((((dest_off - ((op_off + 3) & ~3)) >> 2) & 0xffff) << 8) | ((reg_dest) << 4) | (1)));
}

static __inline void asm_xtensa_op_mov_n(asm_xtensa_t *as, uint reg_dest, uint reg_src) {
    asm_xtensa_op16(as, (((0) << 12) | ((reg_src) << 8) | ((reg_dest) << 4) | (13)));
}

static __inline void asm_xtensa_op_movi(asm_xtensa_t *as, uint reg_dest, int32_t imm12) {
    asm_xtensa_op24(as, ((((uint32_t)imm12 & 0xff) << 16) | ((10) << 12) | (((imm12 >> 8) & 0xf) << 8) | ((reg_dest) << 4) | (2)));
}


static __inline void asm_xtensa_op_movi_n(asm_xtensa_t *as, uint reg_dest, int imm7) {
    asm_xtensa_op16(as, ((((imm7) & 0xf) << 12) | ((reg_dest) << 8) | ((imm7) & 0x70) | (12)));
}

static __inline void asm_xtensa_op_mull(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)8) << 20) | (((uint32_t)2) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_neg(asm_xtensa_t *as, uint reg_dest, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)6) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((0) << 8) | ((reg_src) << 4) | (0)));
}

static __inline void asm_xtensa_op_or(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)2) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_ret_n(asm_xtensa_t *as) {
    asm_xtensa_op16(as, (((15) << 12) | ((0) << 8) | ((0) << 4) | (13)));
}

static __inline void asm_xtensa_op_retw_n(asm_xtensa_t *as) {
    asm_xtensa_op16(as, (((15) << 12) | ((0) << 8) | ((1) << 4) | (13)));
}

static __inline void asm_xtensa_op_s8i(asm_xtensa_t *as, uint reg_src, uint reg_base, uint byte_offset) {
    asm_xtensa_op24(as, ((((uint32_t)byte_offset & 0xff) << 16) | ((4) << 12) | ((reg_base) << 8) | ((reg_src) << 4) | (2)));
}

static __inline void asm_xtensa_op_s16i(asm_xtensa_t *as, uint reg_src, uint reg_base, uint half_word_offset) {
    asm_xtensa_op24(as, ((((uint32_t)half_word_offset & 0xff) << 16) | ((5) << 12) | ((reg_base) << 8) | ((reg_src) << 4) | (2)));
}

static __inline void asm_xtensa_op_s32i(asm_xtensa_t *as, uint reg_src, uint reg_base, uint word_offset) {
    asm_xtensa_op24(as, ((((uint32_t)word_offset & 0xff) << 16) | ((6) << 12) | ((reg_base) << 8) | ((reg_src) << 4) | (2)));
}

static __inline void asm_xtensa_op_s32i_n(asm_xtensa_t *as, uint reg_src, uint reg_base, uint word_offset) {
    asm_xtensa_op16(as, (((word_offset & 0xf) << 12) | ((reg_base) << 8) | ((reg_src) << 4) | (9)));
}

static __inline void asm_xtensa_op_sll(asm_xtensa_t *as, uint reg_dest, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)10) << 20) | (((uint32_t)1) << 16) | ((reg_dest) << 12) | ((reg_src) << 8) | ((0) << 4) | (0)));
}

static __inline void asm_xtensa_op_srl(asm_xtensa_t *as, uint reg_dest, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)9) << 20) | (((uint32_t)1) << 16) | ((reg_dest) << 12) | ((0) << 8) | ((reg_src) << 4) | (0)));
}

static __inline void asm_xtensa_op_sra(asm_xtensa_t *as, uint reg_dest, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)11) << 20) | (((uint32_t)1) << 16) | ((reg_dest) << 12) | ((0) << 8) | ((reg_src) << 4) | (0)));
}

static __inline void asm_xtensa_op_ssl(asm_xtensa_t *as, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)4) << 20) | (((uint32_t)0) << 16) | ((1) << 12) | ((reg_src) << 8) | ((0) << 4) | (0)));
}

static __inline void asm_xtensa_op_ssr(asm_xtensa_t *as, uint reg_src) {
    asm_xtensa_op24(as, ((((uint32_t)4) << 20) | (((uint32_t)0) << 16) | ((0) << 12) | ((reg_src) << 8) | ((0) << 4) | (0)));
}

static __inline void asm_xtensa_op_sub(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)12) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}

static __inline void asm_xtensa_op_xor(asm_xtensa_t *as, uint reg_dest, uint reg_src_a, uint reg_src_b) {
    asm_xtensa_op24(as, ((((uint32_t)3) << 20) | (((uint32_t)0) << 16) | ((reg_dest) << 12) | ((reg_src_a) << 8) | ((reg_src_b) << 4) | (0)));
}
...
#line 470 "E:\\Work\\code\\opensource\\micropython\\py/asmxtensa.h"

#line 472 "E:\\Work\\code\\opensource\\micropython\\py/asmxtensa.h"
#line 36 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"



#line 40 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"

#line 42 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
...
#line 73 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
}

void asm_xtensa_entry(asm_xtensa_t *as, int num_locals) {
    if (as->num_const > 0) {
        
        asm_xtensa_op_j(as, as->num_const * (4) + 4 - 4);
    ...
    as->stack_adjust = ((((5) + num_locals) * (4)) + 15) & ~15;
    if (((((-as->stack_adjust) & 0xffffff80) == 0) || (((-as->stack_adjust) & 0xffffff80) == 0xffffff80))) {
        asm_xtensa_op_addi(as, (1), (1), -as->stack_adjust);
    } else {
        asm_xtensa_op_movi(as, (9), as->stack_adjust);
        asm_xtensa_op_sub(as, (1), (1), (9));
    }

    
    asm_xtensa_op_s32i_n(as, (0), (1), 0);
    for (int i = 1; i < (5); ++i) {
        asm_xtensa_op_s32i_n(as, (11) + i, (1), i);
    }
}
...
void asm_xtensa_exit(asm_xtensa_t *as) {
    ...
    for (int i = (5) - 1; i >= 1; --i) {
        asm_xtensa_op_l32i_n(as, (11) + i, (1), i);
    }
    asm_xtensa_op_l32i_n(as, (0), (1), 0);
...
void asm_xtensa_entry_win(asm_xtensa_t *as, int num_locals) {
    ...
    as->stack_adjust = 32 + (((((1) + num_locals) * (4)) + 15) & ~15);
    asm_xtensa_op_entry(as, (1), as->stack_adjust);
    asm_xtensa_op_s32i_n(as, (0), (1), 0);
}
...
static uint32_t get_label_dest(asm_xtensa_t *as, uint label) {
    ((void)( (!!(label < as->base.max_num_labels)) || (_wassert(L"label < as->base.max_num_labels", L"E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c", (unsigned)(134)), 0)) );
...
static _Bool calculate_branch_displacement(asm_xtensa_t *as, uint label, ptrdiff_t *displacement) {
    ((void)( (!!(displacement != ((void *)0) && "Displacement pointer is NULL")) || (_wassert(L"displacement != NULL && \"Displacement pointer is NULL\"", L"E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c", (unsigned)(163)), 0)) );
...
void asm_xtensa_bccz_reg_label(asm_xtensa_t *as, uint cond, uint reg, uint label) {
    ptrdiff_t rel = 0;
    _Bool can_emit_short_jump = calculate_branch_displacement(as, label, &rel);

    if (can_emit_short_jump && ((((rel) & 0xfffff800) == 0) || (((rel) & 0xfffff800) == 0xfffff800))) {
    ...
    if (as->base.pass == (2) && !((((rel - 6) & 0xfffe0000) == 0) || (((rel - 6) & 0xfffe0000) == 0xfffe0000))) {
        mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: xtensa %q out of range", MP_QSTR_bccz);
    }
...
void asm_xtensa_bcc_reg_reg_label(asm_xtensa_t *as, uint cond, uint reg1, uint reg2, uint label) {
    ...
    if (can_emit_short_jump && ((((rel) & 0xffffff80) == 0) || (((rel) & 0xffffff80) == 0xffffff80))) {
    ...
    if (as->base.pass == (2) && !((((rel - 6) & 0xfffe0000) == 0) || (((rel - 6) & 0xfffe0000) == 0xfffe0000))) {
        mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: xtensa %q out of range", MP_QSTR_bcc);
    }
...
size_t asm_xtensa_mov_reg_i32(asm_xtensa_t *as, uint reg_dest, uint32_t i32) {
    ...
    size_t loc = const_table_offset + as->cur_const * (4);
    asm_xtensa_op_l32r(as, reg_dest, as->base.code_offset, loc);
    
    if (as->const_table != ((void *)0)) {
        as->const_table[as->cur_const] = i32;
    } else {
        ((void)( (!!((as->base.pass != (2)) && "Constants table was not built.")) || (_wassert(L"(as->base.pass != MP_ASM_PASS_EMIT) && \"Constants table was not built.\"", L"E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c", (unsigned)(234)), 0)) );
    }
    ++as->cur_const;
    return loc;
}
...
void asm_xtensa_mov_reg_i32_optimised(asm_xtensa_t *as, uint reg_dest, uint32_t i32) {
    ...
    } else if (((((i32) & 0xfffff800) == 0) || (((i32) & 0xfffff800) == 0xfffff800))) {
...
void asm_xtensa_mov_local_reg(asm_xtensa_t *as, int local_num, uint reg_src) {
    asm_xtensa_op_s32i(as, reg_src, (1), local_num);
}

void asm_xtensa_mov_reg_local(asm_xtensa_t *as, uint reg_dest, int local_num) {
    asm_xtensa_op_l32i(as, reg_dest, (1), local_num);
}

void asm_xtensa_mov_reg_local_addr(asm_xtensa_t *as, uint reg_dest, int local_num) {
    uint off = local_num * (4);
    if (((((off) & 0xffffff80) == 0) || (((off) & 0xffffff80) == 0xffffff80))) {
        asm_xtensa_op_addi(as, reg_dest, (1), off);
    } else {
        asm_xtensa_op_movi(as, reg_dest, off);
        asm_xtensa_op_add_n(as, reg_dest, reg_dest, (1));
    }
}
...
void asm_xtensa_mov_reg_pcrel(asm_xtensa_t *as, uint reg_dest, uint label) {
    ...
    asm_xtensa_op_add_n(as, reg_dest, reg_dest, (0));
}
...
void asm_xtensa_load_reg_reg_offset(asm_xtensa_t *as, uint reg_dest, uint reg_base, uint offset, uint operation_size) {
    ((void)( (!!(operation_size <= 2 && "Operation size value out of range.")) || (_wassert(L"operation_size <= 2 && \"Operation size value out of range.\"", L"E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c", (unsigned)(303)), 0)) );

    if (operation_size == 2 && (((offset) & (~0U << (4))) == 0)) {
        asm_xtensa_op_l32i_n(as, reg_dest, reg_base, offset);
        return;
    }

    if ((((offset) & (~0U << (8))) == 0)) {
        asm_xtensa_op24(as, ((((uint32_t)offset) << 16) | ((operation_size) << 12) | ((reg_base) << 8) | ((reg_dest) << 4) | (2)));
        return;
    }
    ...
    if (operation_size == 2) {
        ...
        asm_xtensa_op24(as, ((((uint32_t)0) << 16) | ((operation_size) << 12) | ((reg_dest) << 8) | ((reg_dest) << 4) | (2)));
    }
}

void asm_xtensa_store_reg_reg_offset(asm_xtensa_t *as, uint reg_src, uint reg_base, uint offset, uint operation_size) {
    ((void)( (!!(operation_size <= 2 && "Operation size value out of range.")) || (_wassert(L"operation_size <= 2 && \"Operation size value out of range.\"", L"E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c", (unsigned)(325)), 0)) );
    ...
    if ((((offset) & (~0U << (8))) == 0)) {
        asm_xtensa_op24(as, ((((uint32_t)offset) << 16) | ((0x04 | operation_size) << 12) | ((reg_base) << 8) | ((reg_src) << 4) | (2)));
        return;
    }

    asm_xtensa_mov_reg_i32_optimised(as, (6), offset << operation_size);
    asm_xtensa_op_add_n(as, (6), reg_base, (6));
    if (operation_size == 2) {
        asm_xtensa_op_s32i_n(as, reg_src, (6), 0);
    } else {
        asm_xtensa_op24(as, ((((uint32_t)0) << 16) | ((0x04 | operation_size) << 12) | (((6)) << 8) | ((reg_src) << 4) | (2)));
    }
}

void asm_xtensa_call_ind(asm_xtensa_t *as, uint idx) {
    asm_xtensa_l32i_optimised(as, (0), (15), idx);
    asm_xtensa_op_callx0(as, (0));
}

void asm_xtensa_call_ind_win(asm_xtensa_t *as, uint idx) {
    asm_xtensa_l32i_optimised(as, (8), (7), idx);
    asm_xtensa_op_callx8(as, (8));
}

void asm_xtensa_bit_branch(asm_xtensa_t *as, mp_uint_t reg, mp_uint_t bit, mp_uint_t label, mp_uint_t condition) {
    uint32_t dest = get_label_dest(as, label);
    int32_t rel = dest - as->base.code_offset - 4;
    if (as->base.pass == (2) && !((((rel) & 0xffffff80) == 0) || (((rel) & 0xffffff80) == 0xffffff80))) {
        mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: xtensa %q out of range", MP_QSTR_bit_branch);
    }
    asm_xtensa_op24(as, ((((uint32_t)rel & 0xFF) << 16) | ((condition | ((bit >> 4) & 0x01)) << 12) | ((reg) << 8) | ((bit & 0x0F) << 4) | (7)));
}
...
void asm_xtensa_call0(asm_xtensa_t *as, mp_uint_t label) {
    ...
    if (as->base.pass == (2)) {
        if ((dest & 0x03) != 0) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: %q %q not word-aligned", MP_QSTR_call0, MP_QSTR_target);
        }
        if ((rel & 0x03) != 0) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: %q %q not word-aligned", MP_QSTR_call0, MP_QSTR_location);
        }
        if (!((((rel) & 0xfffe0000) == 0) || (((rel) & 0xfffe0000) == 0xfffe0000))) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: xtensa %q out of range", MP_QSTR_call0);
        }
    }
...
void asm_xtensa_l32r(asm_xtensa_t *as, mp_uint_t reg, mp_uint_t label) {
    ...
    if (as->base.pass == (2)) {
        if ((dest & 0x03) != 0) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: %q %q not word-aligned", MP_QSTR_l32r, MP_QSTR_target);
        }
        if ((rel & 0x03) != 0) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: %q %q not word-aligned", MP_QSTR_l32r, MP_QSTR_location);
        }
        if (!((((rel) & 0xfffe0000) == 0) || (((rel) & 0xfffe0000) == 0xfffe0000)) || (rel >= 0)) {
            mp_raise_msg_varg(&mp_type_RuntimeError, (mp_rom_error_text_t)"ERROR: xtensa %q out of range", MP_QSTR_l32r);
        }
    }
    asm_xtensa_op_l32r(as, reg, as->base.code_offset, dest);
}

#line 400 "E:\\Work\\code\\opensource\\micropython\\py\\asmxtensa.c"
