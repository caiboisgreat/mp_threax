#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\pairheap.c"
...
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/pairheap.h"
...
#pragma warning(pop) 
#line 39 "E:\\Work\\code\\opensource\\micropython\\py/pairheap.h"
...
#line 40 "E:\\Work\\code\\opensource\\micropython\\py/pairheap.h"
...
static __inline mp_pairheap_t *mp_pairheap_new(mp_pairheap_lt_t lt) {
    (void)lt;
    return ((void *)0);
}


static __inline void mp_pairheap_init_node(mp_pairheap_lt_t lt, mp_pairheap_t *node) {
    (void)lt;
    node->child = ((void *)0);
    node->next = ((void *)0);
}
...
static __inline _Bool mp_pairheap_is_empty(mp_pairheap_lt_t lt, mp_pairheap_t *heap) {
    (void)lt;
    return heap == ((void *)0);
}


static __inline mp_pairheap_t *mp_pairheap_peek(mp_pairheap_lt_t lt, mp_pairheap_t *heap) {
    (void)lt;
    return heap;
}


static __inline mp_pairheap_t *mp_pairheap_push(mp_pairheap_lt_t lt, mp_pairheap_t *heap, mp_pairheap_t *node) {
    ((void)( (!!(node->child == ((void *)0) && node->next == ((void *)0))) || (_wassert(L"node->child == NULL && node->next == NULL", L"E:\\Work\\code\\opensource\\micropython\\py/pairheap.h", (unsigned)(88)), 0)) );
    return mp_pairheap_meld(lt, node, heap); 
}


static __inline mp_pairheap_t *mp_pairheap_pop(mp_pairheap_lt_t lt, mp_pairheap_t *heap) {
    ((void)( (!!(heap->next == ((void *)0))) || (_wassert(L"heap->next == NULL", L"E:\\Work\\code\\opensource\\micropython\\py/pairheap.h", (unsigned)(94)), 0)) );
    mp_pairheap_t *child = heap->child;
    heap->child = ((void *)0);
    return mp_pairheap_pairing(lt, child);
}

#line 101 "E:\\Work\\code\\opensource\\micropython\\py/pairheap.h"
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\pairheap.c"
...
mp_pairheap_t *mp_pairheap_meld(mp_pairheap_lt_t lt, mp_pairheap_t *heap1, mp_pairheap_t *heap2) {
    ...
    if (lt(heap1, heap2)) {
        if (heap1->child == ((void *)0)) {
            heap1->child = heap2;
        } else {
            heap1->child_last->next = heap2;
        }
        heap1->child_last = heap2;
        heap2->next = ((void *)((uintptr_t)(heap1) | 1));
        return heap1;
    } else {
        heap1->next = heap2->child;
        heap2->child = heap1;
        if (heap1->next == ((void *)0)) {
            heap2->child_last = heap1;
            heap1->next = ((void *)((uintptr_t)(heap2) | 1));
        }
        return heap2;
    }
}
...
mp_pairheap_t *mp_pairheap_pairing(mp_pairheap_lt_t lt, mp_pairheap_t *child) {
    ...
    mp_pairheap_t *heap = ((void *)0);
    while (!((uintptr_t)(child) & 1)) {
        mp_pairheap_t *n1 = child;
        child = child->next;
        n1->next = ((void *)0);
        if (!((uintptr_t)(child) & 1)) {
...
mp_pairheap_t *mp_pairheap_delete(mp_pairheap_lt_t lt, mp_pairheap_t *heap, mp_pairheap_t *node) {
    ...
    while (!((uintptr_t)(parent->next) & 1)) {
        parent = parent->next;
    }
    parent = ((void *)((uintptr_t)(parent->next) & ~1));

    
    mp_pairheap_t *next;
    if (node == parent->child && node->child == ((void *)0)) {
