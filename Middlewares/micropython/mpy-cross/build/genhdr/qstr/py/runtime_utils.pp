#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\runtime_utils.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\runtime_utils.c"

mp_obj_t mp_call_function_1_protected(mp_obj_t fun, mp_obj_t arg) {
    nlr_buf_t nlr;
    if ((nlr_push_tail(&nlr), _setjmp((&nlr)->jmpbuf)) == 0) {
...
_Bool mp_mul_ll_overflow(long long int x, long long int y, long long int *res) {
    ...
    if (x > 0) { 
        if (y > 0) { 
            overflow = (x > (9223372036854775807i64 / y));
        } else { 
            overflow = (y < ((-9223372036854775807i64 - 1) / x));
        } 
    } else { 
        if (y > 0) { 
            overflow = (x < ((-9223372036854775807i64 - 1) / y));
        } else { 
            overflow = (x != 0 && y < (9223372036854775807i64 / x));
        } 
    } 
...
_Bool mp_mul_mp_int_t_overflow(mp_int_t x, mp_int_t y, mp_int_t *res) {
    ...
    if (x > 0) { 
        if (y > 0) { 
            if (x > (9223372036854775807i64 / y)) {
                return 1;
            }
        } else { 
            if (y < ((-9223372036854775807i64 - 1) / x)) {
                return 1;
            }
        } 
    } else { 
        if (y > 0) { 
            if (x < ((-9223372036854775807i64 - 1) / y)) {
                return 1;
            }
        } else { 
            if (x != 0 && y < (9223372036854775807i64 / x)) {
                return 1;
            }
        } 
    } 
...
#line 109 "E:\\Work\\code\\opensource\\micropython\\py\\runtime_utils.c"
