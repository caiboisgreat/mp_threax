#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#pragma warning(pop) 
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/mphal.h"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py/mphal.h"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 36 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 37 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 38 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"


#line 1 "E:\\Work\\code\\opensource\\micropython\\py/formatfloat.h"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py/formatfloat.h"

#line 37 "E:\\Work\\code\\opensource\\micropython\\py/formatfloat.h"
#line 41 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
#line 42 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
int mp_print_strn(const mp_print_t *print, const char *str, size_t len, unsigned int flags, char fill, int width) {
    ...
    char grouping = flags >> (9);

    if (!fill || fill == ' ') {
        pad_chars = pad_spaces;
        pad_size = (sizeof(pad_spaces));
    } else if (fill == '0' && !grouping) {
        pad_chars = (pad_common + 0);
        pad_size = (16);
    } else if (fill == '0') {
        if (grouping == '_') {
            pad_chars = (pad_common + 12);
            pad_size = (5);
        } else {
            pad_chars = (pad_common + 17);
            pad_size = (4);
        }
...
#line 203 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 217 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
    } else {
...
#line 224 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
        if (sign && b > buf) {
            *(--b) = sign;
        }
    }
...
int mp_print_mp_int(const mp_print_t *print, mp_obj_t x, unsigned int base, int base_char, int flags, char fill, int width, int prec) {
    ...
    ((void)( (!!(base == 2 || base == 8 || base == 10 || base == 16)) || (_wassert(L"base == 2 || base == 8 || base == 10 || base == 16", L"E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c", (unsigned)(237)), 0)) );
...
int mp_print_float(const mp_print_t *print, mp_float_t f, char fmt, unsigned int flags, char fill, int width, int prec) {
    ...
    if ((flags & (0x100)) && strchr(buf, '.') == ((void *)0) && strchr(buf, 'e') == ((void *)0) && strchr(buf, 'n') == ((void *)0)) {
        buf[len++] = '.';
        buf[len++] = '0';
        buf[len] = '\0';
    }
...
#line 410 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
int mp_vprintf(const mp_print_t *print, const char *fmt, va_list args) {
    ...
    for (;;) {
        ...
        if (*fmt == '.') {
            ...
            if (*fmt == '*') {
                ++fmt;
                prec = ((sizeof(int) > sizeof(__int64) || (sizeof(int) & (sizeof(int) - 1)) != 0) ? **(int**)((args += sizeof(__int64)) - sizeof(__int64)) : *(int* )((args += sizeof(__int64)) - sizeof(__int64)));
            } else {
                prec = 0;
                for (; '0' <= *fmt && *fmt <= '9'; ++fmt) {
                    prec = prec * 10 + *fmt - '0';
...
#line 488 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
        
        #line 490 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
        

#line 493 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"

        
        
        

#line 499 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
        
        _Bool long_long_arg = 0;
        #line 502 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"

        if (*fmt == 'l') {
            ++fmt;
            

#line 508 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
            
            if (*fmt == 'l') {
                ++fmt;
                long_long_arg = 1;
            }
            #line 514 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
        }
        ...
        switch (*fmt) {
            case 'b':
                if (((sizeof(int) > sizeof(__int64) || (sizeof(int) & (sizeof(int) - 1)) != 0) ? **(int**)((args += sizeof(__int64)) - sizeof(__int64)) : *(int* )((args += sizeof(__int64)) - sizeof(__int64)))) {
                ...
                break;
            case 'c': {
                char str = ((sizeof(int) > sizeof(__int64) || (sizeof(int) & (sizeof(int) - 1)) != 0) ? **(int**)((args += sizeof(__int64)) - sizeof(__int64)) : *(int* )((args += sizeof(__int64)) - sizeof(__int64)));
                chrs += mp_print_strn(print, &str, 1, flags, fill, width);
                break;
            }
            case 'q': {
                qstr qst = ((sizeof(qstr) > sizeof(__int64) || (sizeof(qstr) & (sizeof(qstr) - 1)) != 0) ? **(qstr**)((args += sizeof(__int64)) - sizeof(__int64)) : *(qstr* )((args += sizeof(__int64)) - sizeof(__int64)));
                size_t len;
            ...
            case 's': {
                const char *str = ((sizeof(const char *) > sizeof(__int64) || (sizeof(const char *) & (sizeof(const char *) - 1)) != 0) ? **(const char ***)((args += sizeof(__int64)) - sizeof(__int64)) : *(const char ** )((args += sizeof(__int64)) - sizeof(__int64)));
                ...
                #line 552 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
                size_t len = strlen(str);
                if (prec >= 0 && (size_t)prec < len) {
                    len = prec;
                }
            ...
            case 'X': {
                ...
                if (fmt_chr == 'p' || fmt_chr == 'P') {
                    val = ((sizeof(uintptr_t) > sizeof(__int64) || (sizeof(uintptr_t) & (sizeof(uintptr_t) - 1)) != 0) ? **(uintptr_t**)((args += sizeof(__int64)) - sizeof(__int64)) : *(uintptr_t* )((args += sizeof(__int64)) - sizeof(__int64)));
                }
                
                else if (long_long_arg) {
                    val = ((sizeof(unsigned long long) > sizeof(__int64) || (sizeof(unsigned long long) & (sizeof(unsigned long long) - 1)) != 0) ? **(unsigned long long**)((args += sizeof(__int64)) - sizeof(__int64)) : *(unsigned long long* )((args += sizeof(__int64)) - sizeof(__int64)));
                }
                #line 575 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
...
#line 584 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
                else {
                    if (sizeof(int) != sizeof(mp_uint_t) && fmt_chr == 'd') {
                        val = ((sizeof(int) > sizeof(__int64) || (sizeof(int) & (sizeof(int) - 1)) != 0) ? **(int**)((args += sizeof(__int64)) - sizeof(__int64)) : *(int* )((args += sizeof(__int64)) - sizeof(__int64)));
                    } else {
                        val = ((sizeof(unsigned) > sizeof(__int64) || (sizeof(unsigned) & (sizeof(unsigned) - 1)) != 0) ? **(unsigned**)((args += sizeof(__int64)) - sizeof(__int64)) : *(unsigned* )((args += sizeof(__int64)) - sizeof(__int64)));
                    }
                }
                int base;
            ...
            case 'G': {
                ...
                mp_float_t f = (mp_float_t)((sizeof(double) > sizeof(__int64) || (sizeof(double) & (sizeof(double) - 1)) != 0) ? **(double**)((args += sizeof(__int64)) - sizeof(__int64)) : *(double* )((args += sizeof(__int64)) - sizeof(__int64)));
                chrs += mp_print_float(print, f, *fmt, flags, fill, width, prec);
                

#line 616 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
                break;
            }
            #line 619 "E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c"
            default:
                
                ((void)( (!!(*fmt == '%' || !"unsupported fmt char")) || (_wassert(L"*fmt == '%' || !\"unsupported fmt char\"", L"E:\\Work\\code\\opensource\\micropython\\py\\mpprint.c", (unsigned)(621)), 0)) );
