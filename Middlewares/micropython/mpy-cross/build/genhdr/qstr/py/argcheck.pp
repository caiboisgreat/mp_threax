#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"

void mp_arg_check_num_sig(size_t n_args, size_t n_kw, uint32_t sig) {
    

    
    _Bool takes_kw = sig & 1;
...
#line 44 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        mp_raise_TypeError((mp_rom_error_text_t)"function doesn't take keyword arguments");
        #line 46 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
    }
...
#line 53 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
            mp_raise_msg_varg(&mp_type_TypeError,
                (mp_rom_error_text_t)"function takes %d positional arguments but %d were given",
                n_args_min, n_args);
            #line 57 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        }
    } else {
        if (n_args < n_args_min) {
            

#line 63 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
            mp_raise_msg_varg(&mp_type_TypeError,
                (mp_rom_error_text_t)"function missing %d required positional arguments",
                n_args_min - n_args);
            #line 67 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        } else if (n_args > n_args_max) {
            

#line 71 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
            mp_raise_msg_varg(&mp_type_TypeError,
                (mp_rom_error_text_t)"function expected at most %d arguments, got %d",
                n_args_max, n_args);
            #line 75 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        }
    }
}
...
void mp_arg_parse_all(size_t n_pos, const mp_obj_t *pos, mp_map_t *kws, size_t n_allowed, const mp_arg_t *allowed, mp_arg_val_t *out_vals) {
    ...
    for (size_t i = 0; i < n_allowed; i++) {
        ...
        if (i < n_pos) {
            ...
            mp_map_elem_t *kw = mp_map_lookup(kws, ((mp_obj_t)((((mp_uint_t)(allowed[i].qst)) << 3) | 2)), MP_MAP_LOOKUP);
            if (kw == ((void *)0)) {
                if (allowed[i].flags & MP_ARG_REQUIRED) {
                    

#line 96 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
                    mp_raise_msg_varg(&mp_type_TypeError, (mp_rom_error_text_t)"'%q' argument required", allowed[i].qst);
                    #line 98 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
                }
        ...
        if ((allowed[i].flags & MP_ARG_KIND_MASK) == MP_ARG_BOOL) {
            ...
            ((void)( (!!((allowed[i].flags & MP_ARG_KIND_MASK) == MP_ARG_OBJ)) || (_wassert(L"(allowed[i].flags & MP_ARG_KIND_MASK) == MP_ARG_OBJ", L"E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c", (unsigned)(111)), 0)) );
...
#line 120 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        
        mp_raise_TypeError((mp_rom_error_text_t)"extra positional arguments given");
        #line 123 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
    }
    if (kws_found < kws->used) {
        

#line 128 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
        
        mp_raise_TypeError((mp_rom_error_text_t)"extra keyword arguments given");
        #line 131 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
    }
}
...
__declspec(noreturn) void mp_arg_error_terse_mismatch(void) {
    mp_raise_TypeError((mp_rom_error_text_t)"argument num/types mismatch");
}


__declspec(noreturn) void mp_arg_error_unimpl_kw(void) {
    mp_raise_NotImplementedError((mp_rom_error_text_t)"keyword argument(s) not implemented - use normal args instead");
}
#line 149 "E:\\Work\\code\\opensource\\micropython\\py\\argcheck.c"
