#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"
...
static mp_obj_t closure_call(mp_obj_t self_in, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    mp_obj_closure_t *self = ((void *)(self_in));
    ...
    if (n_total <= 5) {
        ...
        mp_obj_t *args2 = ((mp_obj_t *)(m_malloc(sizeof(mp_obj_t) * (n_total))));
        memcpy(args2, self->closed, self->n_closed * sizeof(mp_obj_t));
        memcpy(args2 + self->n_closed, args, (n_args + 2 * n_kw) * sizeof(mp_obj_t));
        mp_obj_t res = mp_call_function_n_kw(self->fun, self->n_closed + n_args, n_kw, args2);
        ((void)(n_total), m_free(args2));
        return res;
    }
}
...
#line 80 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"
...
#line 89 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"

#line 91 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"





#line 97 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"

const mp_obj_type_t mp_type_closure = { .base = { &mp_type_type }, .flags = (0x0020), .name = MP_QSTR_closure, .slot_index_print = 1, .slot_index_call = 2, .slots = { closure_print, closure_call, } };
#line 106 "E:\\Work\\code\\opensource\\micropython\\py\\objclosure.c"

mp_obj_t mp_obj_new_closure(mp_obj_t fun, size_t n_closed_over, const mp_obj_t *closed) {
    mp_obj_closure_t *o = ((mp_obj_closure_t *)mp_obj_malloc_helper(((size_t)&(((mp_obj_closure_t*)0)->closed)) + sizeof(mp_obj_t) * (n_closed_over), &mp_type_closure));
    o->fun = fun;
