#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\scope.c"
...
#pragma warning(pop) 
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\scope.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\scope.c"
...
scope_t *scope_new(scope_kind_t kind, mp_parse_node_t pn, mp_uint_t emit_options) {
    ...
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_module_gt_ <= 0xffui8)]));
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_lambda_gt_ <= 0xffui8)]));
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_listcomp_gt_ <= 0xffui8)]));
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_dictcomp_gt_ <= 0xffui8)]));
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_setcomp_gt_ <= 0xffui8)]));
    ((void)sizeof(char[1 - 2 * !(MP_QSTR__lt_genexpr_gt_ <= 0xffui8)]));

    scope_t *scope = ((scope_t *)(m_malloc0(sizeof(scope_t) * (1))));
    scope->kind = kind;
    scope->pn = pn;
    if (kind == SCOPE_FUNCTION || kind == SCOPE_CLASS) {
        ((void)( (!!(((pn) != (0) && ((pn) & 3) == 0))) || (_wassert(L"MP_PARSE_NODE_IS_STRUCT(pn)", L"E:\\Work\\code\\opensource\\micropython\\py\\scope.c", (unsigned)(58)), 0)) );
        scope->simple_name = (((uintptr_t)(((mp_parse_node_struct_t *)pn)->nodes[0])) >> 4);
    } else {
        scope->simple_name = scope_simple_name_table[kind];
    }
    scope->raw_code = mp_emit_glue_new_raw_code();
    scope->emit_options = emit_options;
    scope->id_info_alloc = (4);
    scope->id_info = ((id_info_t *)(m_malloc(sizeof(id_info_t) * (scope->id_info_alloc))));

    return scope;
}

void scope_free(scope_t *scope) {
    ((void)(scope->id_info_alloc), m_free(scope->id_info));
    ((void)(1), m_free(scope));
}
...
id_info_t *scope_find_or_add_id(scope_t *scope, qstr qst, id_info_kind_t kind) {
    ...
    if (scope->id_info_len >= scope->id_info_alloc) {
        scope->id_info = ((id_info_t *)(m_realloc((scope->id_info), sizeof(id_info_t) * (scope->id_info_alloc + (6)))));
        scope->id_info_alloc += (6);
    }
...
static void scope_close_over_in_parents(scope_t *scope, qstr qst) {
    ((void)( (!!(scope->parent != ((void *)0))) || (_wassert(L"scope->parent != NULL", L"E:\\Work\\code\\opensource\\micropython\\py\\scope.c", (unsigned)(117)), 0)) ); 
    for (scope_t *s = scope->parent;; s = s->parent) {
        ((void)( (!!(s->parent != ((void *)0))) || (_wassert(L"s->parent != NULL", L"E:\\Work\\code\\opensource\\micropython\\py\\scope.c", (unsigned)(119)), 0)) ); 
        ...
        if (id->kind == ID_INFO_KIND_UNDECIDED) {
            ...
            if (id->kind == ID_INFO_KIND_LOCAL) {
                ...
                ((void)( (!!(id->kind == ID_INFO_KIND_FREE || id->kind == ID_INFO_KIND_CELL)) || (_wassert(L"id->kind == ID_INFO_KIND_FREE || id->kind == ID_INFO_KIND_CELL", L"E:\\Work\\code\\opensource\\micropython\\py\\scope.c", (unsigned)(132)), 0)) );
            }
            return;
        }
    }
...
void scope_check_to_close_over(scope_t *scope, id_info_t *id) {
    if (scope->parent != ((void *)0)) {
        for (scope_t *s = scope->parent; s->parent != ((void *)0); s = s->parent) {
...
#line 155 "E:\\Work\\code\\opensource\\micropython\\py\\scope.c"
