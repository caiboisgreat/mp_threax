#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
...
#pragma warning(pop) 
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"

#line 1 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/lexer.h"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py/lexer.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/scope.h"
...
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
...
static __inline mp_parse_node_t mp_parse_node_new_small_int(mp_int_t val) {
    return (mp_parse_node_t)((0x1) | ((mp_uint_t)val << 1));
}

static __inline mp_parse_node_t mp_parse_node_new_leaf(size_t kind, mp_int_t arg) {
    return (mp_parse_node_t)(kind | ((mp_uint_t)arg << 4));
}

static __inline mp_obj_t mp_parse_node_extract_const_object(mp_parse_node_struct_t *pns) {
    


#line 90 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
    return (mp_obj_t)pns->nodes[0];
    #line 92 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
}
...
#line 117 "E:\\Work\\code\\opensource\\micropython\\py/parse.h"
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/scope.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/scope.h"
...
#line 82 "E:\\Work\\code\\opensource\\micropython\\py/scope.h"
...
#line 104 "E:\\Work\\code\\opensource\\micropython\\py/scope.h"
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
...
typedef struct _mp_emit_common_t {
    ...
    mp_map_t qstr_map;
    #line 102 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
...
typedef struct _emit_method_table_t {
    ...
    #line 115 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"

    void (*start_pass)(emit_t *emit, pass_kind_t pass, scope_t *scope);
    _Bool (*end_pass)(emit_t *emit);
    ...
    void (*load_method)(emit_t *emit, qstr qst, _Bool is_super);
    ...
    void (*pop_jump_if)(emit_t *emit, _Bool cond, mp_uint_t label);
    void (*jump_if_or_pop)(emit_t *emit, _Bool cond, mp_uint_t label);
    ...
    #line 150 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
    void (*end_finally)(emit_t *emit);
    void (*get_iter)(emit_t *emit, _Bool use_stack);
    void (*for_iter)(emit_t *emit, mp_uint_t label);
    void (*for_iter_end)(emit_t *emit);
    void (*pop_except_jump)(emit_t *emit, mp_uint_t label, _Bool within_exc_handler);
...
#line 183 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"

size_t mp_emit_common_use_const_obj(mp_emit_common_t *emit, mp_obj_t const_obj);

static __inline size_t mp_emit_common_alloc_const_child(mp_emit_common_t *emit, mp_raw_code_t *rc) {
...
static __inline void mp_emit_common_get_id_for_load(scope_t *scope, qstr qst) {
...
_Bool mp_emit_bc_end_pass(emit_t *emit);
...
void mp_emit_bc_load_method(emit_t *emit, qstr qst, _Bool is_super);
...
void mp_emit_bc_pop_jump_if(emit_t *emit, _Bool cond, mp_uint_t label);
void mp_emit_bc_jump_if_or_pop(emit_t *emit, _Bool cond, mp_uint_t label);
...
#line 273 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
void mp_emit_bc_end_finally(emit_t *emit);
void mp_emit_bc_get_iter(emit_t *emit, _Bool use_stack);
void mp_emit_bc_for_iter(emit_t *emit, mp_uint_t label);
void mp_emit_bc_for_iter_end(emit_t *emit);
void mp_emit_bc_pop_except_jump(emit_t *emit, mp_uint_t label, _Bool within_exc_handler);
...
typedef struct _emit_inline_asm_method_table_t {
    ...
    #line 302 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
    ...
    _Bool (*label)(emit_inline_asm_t *emit, mp_uint_t label_num, qstr label_id);
...
#line 327 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"

#line 329 "E:\\Work\\code\\opensource\\micropython\\py/emit.h"
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"

#line 1 "E:\\Work\\code\\opensource\\micropython\\py/persistentcode.h"
...
#line 79 "E:\\Work\\code\\opensource\\micropython\\py/persistentcode.h"



#line 83 "E:\\Work\\code\\opensource\\micropython\\py/persistentcode.h"
...
#line 134 "E:\\Work\\code\\opensource\\micropython\\py/persistentcode.h"
#line 32 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"
...
typedef struct _mp_fun_table_t {
    ...
    _Bool (*obj_is_true)(mp_obj_t arg);
    ...
    mp_obj_t (*call_method_n_kw_var)(_Bool have_self, size_t n_args_n_kw, const mp_obj_t *args);
...
#line 148 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"
    ...
    _Bool (*get_buffer)(mp_obj_t obj, mp_buffer_info_t *bufinfo, mp_uint_t flags);
...
#line 187 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"


extern const int mp_fun_table;
#line 191 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"

#line 193 "E:\\Work\\code\\opensource\\micropython\\py/nativeglue.h"
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"




qstr_short_t mp_emit_common_use_qstr(mp_emit_common_t *emit, qstr qst) {
    mp_map_elem_t *elem = mp_map_lookup(&emit->qstr_map, ((mp_obj_t)((((mp_uint_t)(qst)) << 3) | 2)), MP_MAP_LOOKUP_ADD_IF_NOT_FOUND);
    if (elem->value == (((mp_obj_t)((void *)0)))) {
        elem->value = ((mp_obj_t)((((mp_uint_t)(emit->qstr_map.used - 1)) << 1) | 1));
    }
    return (((mp_int_t)(elem->value)) >> 1);
}
#line 44 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"



static _Bool strictly_equal(mp_obj_t a, mp_obj_t b) {
    if (a == b) {
        return 1;
    }

    
    if (a == ((mp_obj_t)(&mp_fun_table)) || b == ((mp_obj_t)(&mp_fun_table))) {
        return 0;
    }
    #line 57 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
    ...
    if (a_type == &mp_type_tuple) {
        mp_obj_tuple_t *a_tuple = ((void *)(a));
        mp_obj_tuple_t *b_tuple = ((void *)(b));
        ...
        if (a_type == &mp_type_float) {
            ...
            if (a_val == (mp_float_t)0.0) {
                ...
                return ((__pragma(warning(suppress:6334))(sizeof ((a_val) + (float)0) == sizeof (float) ? 'f' : sizeof ((a_val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdsign((float)(a_val)) : __pragma(warning(suppress:6334))(sizeof ((a_val) + (float)0) == sizeof (float) ? 'f' : sizeof ((a_val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dsign((double)(a_val)) : _ldsign((long double)(a_val)))) == ((__pragma(warning(suppress:6334))(sizeof ((b_val) + (float)0) == sizeof (float) ? 'f' : sizeof ((b_val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdsign((float)(b_val)) : __pragma(warning(suppress:6334))(sizeof ((b_val) + (float)0) == sizeof (float) ? 'f' : sizeof ((b_val) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dsign((double)(b_val)) : _ldsign((long double)(b_val))));
            }
        }
        #line 90 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
        return 1;
    }
}
...
size_t mp_emit_common_use_const_obj(mp_emit_common_t *emit, mp_obj_t const_obj) {
    ...
    mp_obj_list_append(((mp_obj_t)(&emit->const_obj_list)), const_obj);
...
void mp_emit_common_id_op(emit_t *emit, const mp_emit_method_table_id_ops_t *emit_method_table, scope_t *scope, qstr qst) {
    ...
    ((void)( (!!(id != ((void *)0))) || (_wassert(L"id != NULL", L"E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c", (unsigned)(123)), 0)) );

    
    if (id->kind == ID_INFO_KIND_GLOBAL_IMPLICIT || id->kind == ID_INFO_KIND_GLOBAL_IMPLICIT_ASSIGNED) {
        emit_method_table->global(emit, qst, (0));
    } else if (id->kind == ID_INFO_KIND_GLOBAL_EXPLICIT) {
        emit_method_table->global(emit, qst, (1));
    } else if (id->kind == ID_INFO_KIND_LOCAL) {
        emit_method_table->local(emit, qst, id->local_num, (0));
    } else {
        ((void)( (!!(id->kind == ID_INFO_KIND_CELL || id->kind == ID_INFO_KIND_FREE)) || (_wassert(L"id->kind == ID_INFO_KIND_CELL || id->kind == ID_INFO_KIND_FREE", L"E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c", (unsigned)(133)), 0)) );
        emit_method_table->local(emit, qst, id->local_num, (1));
    }
}

#line 139 "E:\\Work\\code\\opensource\\micropython\\py\\emitcommon.c"
