#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/objtype.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
...
static mp_obj_t object_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    mp_obj_object_t *o = ((mp_obj_object_t *)mp_obj_malloc_helper(sizeof(mp_obj_object_t), type));
    return ((mp_obj_t)(o));
}
...
static const mp_obj_fun_builtin_fixed_t object___init___obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = object___init__}};

static mp_obj_t object___new__(mp_obj_t cls) {
    if (!(( ((void)1), ((void)( (!!((&mp_type_type) != &mp_type_bool)) || (_wassert(L"(&mp_type_type) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objobject.c", (unsigned)(51)), 0)) ), ((void)1), ((void)( (!!((&mp_type_type) != &mp_type_int)) || (_wassert(L"(&mp_type_type) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objobject.c", (unsigned)(51)), 0)) ), ((void)1), ((void)( (!!((&mp_type_type) != &mp_type_str)) || (_wassert(L"(&mp_type_type) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objobject.c", (unsigned)(51)), 0)) ), ((void)1), ((void)( (!!((&mp_type_type) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_type) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objobject.c", (unsigned)(51)), 0)) ), 1) && (mp_obj_is_obj(cls) && (((mp_obj_base_t *)((void *)(cls)))->type == (&mp_type_type)))) || !(((mp_obj_type_t *)((void *)(cls)))->flags & (0x0200))) {
        mp_raise_TypeError((mp_rom_error_text_t)"arg must be user-type");
    }
    ...
    return ((mp_obj_t)(mp_obj_new_instance(((void *)(cls)), &native_base)));
}
static const mp_obj_fun_builtin_fixed_t object___new___fun_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = object___new__}};
static const mp_rom_obj_static_class_method_t object___new___obj = {{&mp_type_staticmethod}, (&object___new___fun_obj)};
...
#line 97 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"

static const mp_rom_map_elem_t object_locals_dict_table[] = {
    
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___init__)) << 3) | 2)), (&object___init___obj) },
    #line 102 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
    
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___new__)) << 3) | 2)), (&object___new___obj) },
    #line 105 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
    


#line 109 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
};

static const mp_obj_dict_t object_locals_dict = { .base = {&mp_type_dict}, .map = { .all_keys_are_qstrs = 1, .is_fixed = 1, .is_ordered = 1, .used = (sizeof(object_locals_dict_table) / sizeof((object_locals_dict_table)[0])), .alloc = (sizeof(object_locals_dict_table) / sizeof((object_locals_dict_table)[0])), .table = (mp_map_elem_t *)(mp_rom_map_elem_t *)object_locals_dict_table, }, };
#line 113 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"





#line 119 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"

const mp_obj_type_t mp_type_object = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_object, .slot_index_make_new = 1, .slot_index_locals_dict = 2, .slots = { object_make_new, &object_locals_dict, } };
#line 127 "E:\\Work\\code\\opensource\\micropython\\py\\objobject.c"
