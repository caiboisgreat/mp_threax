#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#line 70 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#line 93 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
...
#line 100 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"



#line 104 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"

#line 106 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"

#line 108 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"

const mp_obj_type_t mp_type_slice = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_slice, .slot_index_unary_op = 1, .slot_index_print = 2, .slots = { slice_unary_op, slice_print, } };
#line 117 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"

mp_obj_t mp_obj_new_slice(mp_obj_t ostart, mp_obj_t ostop, mp_obj_t ostep) {
    mp_obj_slice_t *o = ((mp_obj_slice_t *)mp_obj_malloc_helper(sizeof(mp_obj_slice_t), &mp_type_slice));
    o->start = ostart;
    o->stop = ostop;
    o->step = ostep;
    return ((mp_obj_t)(o));
...
void mp_obj_slice_indices(mp_obj_t self_in, mp_int_t length, mp_bound_slice_t *result) {
    mp_obj_slice_t *self = ((void *)(self_in));
    mp_int_t start, stop, step;

    if (self->step == ((mp_obj_t)(((0) << 3) | 6))) {
        step = 1;
    } else {
        step = mp_obj_get_int(self->step);
        if (step == 0) {
            mp_raise_ValueError((mp_rom_error_text_t)"slice step can't be zero");
        }
    }

    if (step > 0) {
        
        if (self->start == ((mp_obj_t)(((0) << 3) | 6))) {
            start = 0;
        } else {
            ...
            start = ((length) < (((start) > (0) ? (start) : (0))) ? (length) : (((start) > (0) ? (start) : (0))));
        }

        if (self->stop == ((mp_obj_t)(((0) << 3) | 6))) {
            stop = length;
        } else {
            ...
            stop = ((length) < (((stop) > (0) ? (stop) : (0))) ? (length) : (((stop) > (0) ? (stop) : (0))));
        }
    } else {
        ...
        if (self->start == ((mp_obj_t)(((0) << 3) | 6))) {
            ...
            start = ((length - 1) < (((start) > (-1) ? (start) : (-1))) ? (length - 1) : (((start) > (-1) ? (start) : (-1))));
        }
        ...
        if (self->stop == ((mp_obj_t)(((0) << 3) | 6))) {
            ...
            stop = ((length - 1) < (((stop) > (-1) ? (stop) : (-1))) ? (length - 1) : (((stop) > (-1) ? (stop) : (-1))));
        }
    }
...
#line 192 "E:\\Work\\code\\opensource\\micropython\\py\\objslice.c"
