#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\sequence.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\sequence.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\sequence.c"
...
#line 87 "E:\\Work\\code\\opensource\\micropython\\py\\sequence.c"
...
_Bool mp_seq_cmp_bytes(mp_uint_t op, const byte *data1, size_t len1, const byte *data2, size_t len2) {
    ...
    if (op == MP_BINARY_OP_LESS || op == MP_BINARY_OP_LESS_EQUAL) {
        { const byte * t = data2; data2 = data1; data1 = t; };
        { size_t t = len2; len2 = len1; len1 = t; };
...
_Bool mp_seq_cmp_objs(mp_uint_t op, const mp_obj_t *items1, size_t len1, const mp_obj_t *items2, size_t len2) {
    ...
    if (op == MP_BINARY_OP_LESS || op == MP_BINARY_OP_LESS_EQUAL) {
        { const mp_obj_t * t = items2; items2 = items1; items1 = t; };
        { size_t t = len2; len2 = len1; len1 = t; };
        if (op == MP_BINARY_OP_LESS) {
            op = MP_BINARY_OP_MORE;
        } else {
    ...
    for (size_t i = 0; i < len; i++) {
        ...
        return mp_binary_op(op, items1[i], items2[i]) == ((mp_obj_t)(((3) << 3) | 6));
    }
...
mp_obj_t mp_seq_index_obj(const mp_obj_t *items, size_t len, size_t n_args, const mp_obj_t *args) {
    ...
    for (size_t i = start; i < stop; i++) {
        if (mp_obj_equal(items[i], value)) {
            ...
            return ((mp_obj_t)((((mp_uint_t)(i)) << 1) | 1));
        }
    }

    mp_raise_ValueError((mp_rom_error_text_t)"object not in sequence");
}
...
mp_obj_t mp_seq_count_obj(const mp_obj_t *items, size_t len, mp_obj_t value) {
    ...
    return ((mp_obj_t)((((mp_uint_t)(count)) << 1) | 1));
}
