#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#pragma warning(pop) 
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
...
void vstr_init(vstr_t *vstr, size_t alloc) {
    ...
    vstr->alloc = alloc;
    vstr->len = 0;
    vstr->buf = ((char *)(m_malloc(sizeof(char) * (vstr->alloc))));
    vstr->fixed_buf = 0;
}
...
void vstr_clear(vstr_t *vstr) {
    if (!vstr->fixed_buf) {
        ((void)(vstr->alloc), m_free(vstr->buf));
    }
    vstr->buf = ((void *)0);
}

vstr_t *vstr_new(size_t alloc) {
    vstr_t *vstr = (((vstr_t *)(m_malloc(sizeof(vstr_t) * (1)))));
    vstr_init(vstr, alloc);
    return vstr;
}
...
char *vstr_extend(vstr_t *vstr, size_t size) {
    if (vstr->fixed_buf) {
        ...
        mp_raise_msg(&mp_type_RuntimeError, ((void *)0));
    }
    char *new_buf = ((char *)(m_realloc((vstr->buf), sizeof(char) * (vstr->alloc + size))));
...
static void vstr_ensure_extra(vstr_t *vstr, size_t size) {
    if (vstr->len + size > vstr->alloc) {
        ...
        size_t new_alloc = ((((vstr->len + size) + 16) & ((~0U) - 7)) + 8);
        char *new_buf = ((char *)(m_realloc((vstr->buf), sizeof(char) * (new_alloc))));
...
void vstr_add_char(vstr_t *vstr, unichar c) {
    ...
    if (c < 0x80) {
        ...
        *buf = (byte)c;
        ...
        ((void)( (!!(c < 0x110000)) || (_wassert(L"c < 0x110000", L"E:\\Work\\code\\opensource\\micropython\\py\\vstr.c", (unsigned)(164)), 0)) );
...
#line 174 "E:\\Work\\code\\opensource\\micropython\\py\\vstr.c"
}
