#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/objtuple.h"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"




void mp_obj_tuple_print(const mp_print_t *print, mp_obj_t o_in, mp_print_kind_t kind) {
    mp_obj_tuple_t *o = ((void *)(o_in));
    const char *item_separator = ", ";
    if (((((10)) >= (30))) && kind == PRINT_JSON) {
        mp_print_str(print, "[");
        
        item_separator = ((mp_print_ext_t *)print)->item_separator;
        #line 45 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
    } else {
        mp_print_str(print, "(");
        kind = PRINT_REPR;
    }
...
static mp_obj_t mp_obj_tuple_make_new(const mp_obj_type_t *type_in, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    switch (n_args) {
        case 0:
            ...
            return (((mp_obj_t)(&mp_const_empty_tuple_obj)));

        case 1:
        default: {
            
            if ((( ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_bool)) || (_wassert(L"(&mp_type_tuple) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(78)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_int)) || (_wassert(L"(&mp_type_tuple) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(78)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_str)) || (_wassert(L"(&mp_type_tuple) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(78)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_tuple) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(78)), 0)) ), 1) && (mp_obj_is_obj(args[0]) && (((mp_obj_base_t *)((void *)(args[0])))->type == (&mp_type_tuple))))) {
                return args[0];
            }
            ...
            size_t alloc = 4;
            size_t len = 0;
            mp_obj_t *items = ((mp_obj_t *)(m_malloc(sizeof(mp_obj_t) * (alloc))));

            mp_obj_t iterable = mp_getiter(args[0], ((void *)0));
            mp_obj_t item;
            while ((item = mp_iternext(iterable)) != (((mp_obj_t)((void *)0)))) {
                if (len >= alloc) {
                    items = ((mp_obj_t *)(m_realloc((items), sizeof(mp_obj_t) * (alloc * 2))));
                    alloc *= 2;
                }
                items[len++] = item;
            }
...
static mp_obj_t tuple_cmp_helper(mp_uint_t op, mp_obj_t self_in, mp_obj_t another_in) {
    ...
    if (((const void *)(((another_type)->slot_index_iter) ? ((const void *)(another_type)->slots[(another_type)->slot_index_iter - 1]) : ((void *)0))) != mp_obj_tuple_getiter) {
        
        another_in = mp_obj_cast_to_native_base(another_in, ((mp_obj_t)(&mp_type_tuple)));
        if (another_in == (((mp_obj_t)((void *)0)))) {
            return (((mp_obj_t)((void *)0)));
        }
    }
    mp_obj_tuple_t *another = ((void *)(another_in));
...
mp_obj_t mp_obj_tuple_unary_op(mp_unary_op_t op, mp_obj_t self_in) {
    ...
    switch (op) {
        ...
        case MP_UNARY_OP_HASH: {
            ...
            mp_int_t hash = (mp_int_t)(((mp_obj_t)(&mp_const_empty_tuple_obj)));
            for (size_t i = 0; i < self->len; i++) {
                hash += (((mp_int_t)(mp_unary_op(MP_UNARY_OP_HASH, self->items[i]))) >> 1);
            }
            return ((mp_obj_t)((((mp_uint_t)(hash)) << 1) | 1));
        }
...
mp_obj_t mp_obj_tuple_binary_op(mp_binary_op_t op, mp_obj_t lhs, mp_obj_t rhs) {
    mp_obj_tuple_t *o = ((void *)(lhs));
    switch (op) {
        case MP_BINARY_OP_ADD:
        case MP_BINARY_OP_INPLACE_ADD: {
            if (!mp_obj_is_subclass_fast(((mp_obj_t)(mp_obj_get_type(rhs))), ((mp_obj_t)(&mp_type_tuple)))) {
                return (((mp_obj_t)((void *)0))); 
            }
            mp_obj_tuple_t *p = ((void *)(rhs));
            mp_obj_tuple_t *s = ((void *)(mp_obj_new_tuple(o->len + p->len, ((void *)0))));
        ...
        case MP_BINARY_OP_INPLACE_MULTIPLY: {
            ...
            mp_obj_tuple_t *s = ((void *)(mp_obj_new_tuple(o->len * n, ((void *)0))));
...
mp_obj_t mp_obj_tuple_subscr(mp_obj_t self_in, mp_obj_t index, mp_obj_t value) {
    if (value == (((mp_obj_t)((void *)4)))) {
        ...
        if ((( ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_bool)) || (_wassert(L"(&mp_type_slice) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(186)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_int)) || (_wassert(L"(&mp_type_slice) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(186)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_str)) || (_wassert(L"(&mp_type_slice) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(186)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_slice) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(186)), 0)) ), 1) && (mp_obj_is_obj(index) && (((mp_obj_base_t *)((void *)(index)))->type == (&mp_type_slice))))) {
            mp_bound_slice_t slice;
            if (!mp_seq_get_fast_slice_indexes(self->len, index, &slice)) {
                mp_raise_NotImplementedError((mp_rom_error_text_t)"only slices with step=1 (aka None) are supported");
            }
            mp_obj_tuple_t *res = ((void *)(mp_obj_new_tuple(slice.stop - slice.start, ((void *)0))));
            memcpy(res->items, self->items + slice.start, res->len * sizeof(mp_obj_t));
            return ((mp_obj_t)(res));
        }
        #line 196 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
        size_t index_value = mp_get_index(self->base.type, self->len, index, 0);
...
static const mp_obj_fun_builtin_fixed_t tuple_count_obj = {.base = {.type = &mp_type_fun_builtin_2}, .fun = {._2 = tuple_count}};

static mp_obj_t tuple_index(size_t n_args, const mp_obj_t *args) {
    ;
    mp_obj_tuple_t *self = ((void *)(args[0]));
    return mp_seq_index_obj(self->items, self->len, n_args, args);
}
static const mp_obj_fun_builtin_var_t tuple_index_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(4)) << 1) | ((0) ? 1 : 0))), .fun = {.var = tuple_index}};

static const mp_rom_map_elem_t tuple_locals_dict_table[] = {
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_count)) << 3) | 2)), (&tuple_count_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_index)) << 3) | 2)), (&tuple_index_obj) },
};

static const mp_obj_dict_t tuple_locals_dict = { .base = {&mp_type_dict}, .map = { .all_keys_are_qstrs = 1, .is_fixed = 1, .is_ordered = 1, .used = (sizeof(tuple_locals_dict_table) / sizeof((tuple_locals_dict_table)[0])), .alloc = (sizeof(tuple_locals_dict_table) / sizeof((tuple_locals_dict_table)[0])), .table = (mp_map_elem_t *)(mp_rom_map_elem_t *)tuple_locals_dict_table, }, };

const mp_obj_type_t mp_type_tuple = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_tuple, .slot_index_make_new = 1, .slot_index_print = 2, .slot_index_unary_op = 3, .slot_index_binary_op = 4, .slot_index_subscr = 5, .slot_index_iter = 6, .slot_index_locals_dict = 7, .slots = { mp_obj_tuple_make_new, mp_obj_tuple_print, mp_obj_tuple_unary_op, mp_obj_tuple_binary_op, mp_obj_tuple_subscr, mp_obj_tuple_getiter, &tuple_locals_dict, } };
#line 236 "E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c"
...
mp_obj_t mp_obj_new_tuple(size_t n, const mp_obj_t *items) {
    ...
    mp_obj_tuple_t *o = ((mp_obj_tuple_t *)mp_obj_malloc_helper(((size_t)&(((mp_obj_tuple_t*)0)->items)) + sizeof(mp_obj_t) * (n), &mp_type_tuple));
    o->len = n;
    if (items) {
...
void mp_obj_tuple_get(mp_obj_t self_in, size_t *len, mp_obj_t **items) {
    ((void)( (!!((((const void *)(((mp_obj_get_type(self_in))->slot_index_iter) ? ((const void *)(mp_obj_get_type(self_in))->slots[(mp_obj_get_type(self_in))->slot_index_iter - 1]) : ((void *)0))) == mp_obj_tuple_getiter))) || (_wassert(L"mp_obj_is_tuple_compatible(self_in)", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(255)), 0)) );
    mp_obj_tuple_t *self = ((void *)(self_in));
    *len = self->len;
    *items = &self->items[0];
}
...
void mp_obj_tuple_del(mp_obj_t self_in) {
    ((void)( (!!((( ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_bool)) || (_wassert(L"(&mp_type_tuple) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(262)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_int)) || (_wassert(L"(&mp_type_tuple) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(262)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_str)) || (_wassert(L"(&mp_type_tuple) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(262)), 0)) ), ((void)1), ((void)( (!!((&mp_type_tuple) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_tuple) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(262)), 0)) ), 1) && (mp_obj_is_obj(self_in) && (((mp_obj_base_t *)((void *)(self_in)))->type == (&mp_type_tuple)))))) || (_wassert(L"mp_obj_is_type(self_in, &mp_type_tuple)", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(262)), 0)) );
    mp_obj_tuple_t *self = ((void *)(self_in));
    ((void)(self->len), m_free(self));
}
...
mp_obj_t mp_obj_tuple_getiter(mp_obj_t o_in, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_tuple_it_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_tuple_it_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objtuple.c", (unsigned)(289)), 0)) );
