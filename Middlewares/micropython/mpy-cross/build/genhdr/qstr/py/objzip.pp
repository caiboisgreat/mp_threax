#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
...
static mp_obj_t zip_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    mp_obj_zip_t *o = ((mp_obj_zip_t *)mp_obj_malloc_helper(((size_t)&(((mp_obj_zip_t*)0)->iters)) + sizeof(mp_obj_t) * (n_args), type));
    o->n_iters = n_args;
    for (size_t i = 0; i < n_args; i++) {
        o->iters[i] = mp_getiter(args[i], ((void *)0));
    }
    return ((mp_obj_t)(o));
}
...
static mp_obj_t zip_iternext(mp_obj_t self_in) {
    ;
    mp_obj_zip_t *self = ((void *)(self_in));
    if (self->n_iters == 0) {
        return (((mp_obj_t)((void *)0)));
    }
    mp_obj_tuple_t *tuple = ((void *)(mp_obj_new_tuple(self->n_iters, ((void *)0))));

    for (size_t i = 0; i < self->n_iters; i++) {
        mp_obj_t next = mp_iternext(self->iters[i]);
        if (next == (((mp_obj_t)((void *)0)))) {
            mp_obj_tuple_del(((mp_obj_t)(tuple)));
            return (((mp_obj_t)((void *)0)));
        }
        tuple->items[i] = next;
    }
...
const mp_obj_type_t mp_type_zip = { .base = { &mp_type_type }, .flags = (0x0080), .name = MP_QSTR_zip, .slot_index_make_new = 1, .slot_index_iter = 2, .slots = { zip_make_new, zip_iternext, } };
#line 76 "E:\\Work\\code\\opensource\\micropython\\py\\objzip.c"
