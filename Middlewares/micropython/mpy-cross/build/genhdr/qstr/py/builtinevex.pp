#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#pragma warning(pop) 
#line 13 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.26100.0\\ucrt\\malloc.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/objcode.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
#line 1 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
...
#line 40 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
...
void mp_compile_to_raw_code(mp_parse_tree_t *parse_tree, qstr source_file, _Bool is_repl, mp_compiled_module_t *cm);
#line 50 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"


mp_obj_t mp_parse_compile_execute(mp_lexer_t *lex, mp_parse_input_kind_t parse_input_kind, mp_obj_dict_t *globals, mp_obj_dict_t *locals);

#line 55 "E:\\Work\\code\\opensource\\micropython\\py/compile.h"
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#line 137 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
static mp_obj_t eval_exec_helper(size_t n_args, const mp_obj_t *args, mp_parse_input_kind_t parse_input_kind) {
    ...
    for (size_t i = 1; i < 3 && i < n_args; ++i) {
        if (args[i] != ((mp_obj_t)(((0) << 3) | 6))) {
            if (!(( ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_bool)) || (_wassert(L"(&mp_type_dict) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c", (unsigned)(146)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_int)) || (_wassert(L"(&mp_type_dict) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c", (unsigned)(146)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_str)) || (_wassert(L"(&mp_type_dict) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c", (unsigned)(146)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_dict) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c", (unsigned)(146)), 0)) ), 1) && (mp_obj_is_obj(args[i]) && (((mp_obj_base_t *)((void *)(args[i])))->type == (&mp_type_dict))))) {
...
#line 161 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"


    
    
    mp_lexer_t *lex;
    if ((((((10)) >= (10))) && (((10)) >= (30))) && parse_input_kind == MP_PARSE_SINGLE_INPUT) {
...
const mp_obj_fun_builtin_var_t mp_builtin_eval_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = mp_builtin_eval}};

static mp_obj_t mp_builtin_exec(size_t n_args, const mp_obj_t *args) {
    return eval_exec_helper(n_args, args, MP_PARSE_FILE_INPUT);
}
const mp_obj_fun_builtin_var_t mp_builtin_exec_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = mp_builtin_exec}};

#line 191 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
...
#line 199 "E:\\Work\\code\\opensource\\micropython\\py\\builtinevex.c"
