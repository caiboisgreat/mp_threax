#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
...
static const mp_obj_type_t mp_type_range_it = { .base = { &mp_type_type }, .flags = (0x0080), .name = MP_QSTR_iterator, .slot_index_iter = 1, .slots = { range_it_iternext, } };
#line 58 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"

static mp_obj_t mp_obj_new_range_iterator(mp_int_t cur, mp_int_t stop, mp_int_t step, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_range_it_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_range_it_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objrange.c", (unsigned)(60)), 0)) );
...
static void range_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    ...
    mp_printf(print, "range(" "%lld" ", " "%lld" "", self->start, self->stop);
    if (self->step == 1) {
        mp_print_str(print, ")");
    } else {
        mp_printf(print, ", " "%lld" ")", self->step);
    }
}

static mp_obj_t range_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    mp_arg_check_num(n_args, n_kw, 1, 3, 0);

    mp_obj_range_t *o = ((mp_obj_range_t *)mp_obj_malloc_helper(sizeof(mp_obj_range_t), type));
    o->start = 0;
    o->step = 1;
    ...
    if (n_args == 1) {
        ...
        if (n_args == 3) {
            ...
            if (o->step == 0) {
                mp_raise_ValueError((mp_rom_error_text_t)"zero step");
            }
        }
    }
...
#line 158 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
...
static mp_obj_t range_subscr(mp_obj_t self_in, mp_obj_t index, mp_obj_t value) {
    if (value == (((mp_obj_t)((void *)4)))) {
        ...
        if ((( ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_bool)) || (_wassert(L"(&mp_type_slice) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objrange.c", (unsigned)(165)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_int)) || (_wassert(L"(&mp_type_slice) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objrange.c", (unsigned)(165)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_str)) || (_wassert(L"(&mp_type_slice) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objrange.c", (unsigned)(165)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_slice) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objrange.c", (unsigned)(165)), 0)) ), 1) && (mp_obj_is_obj(index) && (((mp_obj_base_t *)((void *)(index)))->type == (&mp_type_slice))))) {
            mp_bound_slice_t slice;
            mp_obj_slice_indices(index, len, &slice);
            mp_obj_range_t *o = ((mp_obj_range_t *)mp_obj_malloc_helper(sizeof(mp_obj_range_t), &mp_type_range));
            o->start = self->start + slice.start * self->step;
            o->stop = self->start + slice.stop * self->step;
            o->step = slice.step * self->step;
            return ((mp_obj_t)(o));
        }
        #line 175 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
        size_t index_val = mp_get_index(self->base.type, len, index, 0);
...
#line 204 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"



#line 208 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"

#line 210 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"





#line 216 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"

const mp_obj_type_t mp_type_range = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_range, .slot_index_make_new = 1, .slot_index_attr = 2, .slot_index_print = 3, .slot_index_unary_op = 4, .slot_index_subscr = 5, .slot_index_iter = 6, .slots = { range_make_new, range_attr, range_print, range_unary_op, range_subscr, range_getiter, } };
#line 229 "E:\\Work\\code\\opensource\\micropython\\py\\objrange.c"
