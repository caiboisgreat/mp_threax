#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objcell.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objcell.c"


static void cell_print(const mp_print_t *print, mp_obj_t o_in, mp_print_kind_t kind) {
    (void)kind;
    mp_obj_cell_t *o = ((void *)(o_in));
    mp_printf(print, "<cell " "%llx" " ", (mp_uint_t)o->obj);
    if (o->obj == (((mp_obj_t)((void *)0)))) {
...
#line 42 "E:\\Work\\code\\opensource\\micropython\\py\\objcell.c"





#line 48 "E:\\Work\\code\\opensource\\micropython\\py\\objcell.c"

static const mp_obj_type_t mp_type_cell = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_, .slot_index_print = 1, .slots = { cell_print, } };
#line 54 "E:\\Work\\code\\opensource\\micropython\\py\\objcell.c"

mp_obj_t mp_obj_new_cell(mp_obj_t obj) {
    mp_obj_cell_t *o = ((mp_obj_cell_t *)mp_obj_malloc_helper(sizeof(mp_obj_cell_t), &mp_type_cell));
    o->obj = obj;
    return ((mp_obj_t)(o));
}
