#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"

_Bool mp_obj_is_dict_or_ordereddict(mp_obj_t o) {
    return mp_obj_is_obj(o) && ((mp_make_new_fun_t)(((((mp_obj_base_t *)((void *)(o)))->type)->slot_index_make_new) ? ((mp_make_new_fun_t)(((mp_obj_base_t *)((void *)(o)))->type)->slots[(((mp_obj_base_t *)((void *)(o)))->type)->slot_index_make_new - 1]) : ((void *)0))) == mp_obj_dict_make_new;
}
...
static mp_map_elem_t *dict_iter_next(mp_obj_dict_t *dict, size_t *cur) {
    ...
    ((void)( (!!(map->used == 0 || i == max)) || (_wassert(L"map->used == 0 || i == max", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(69)), 0)) );
    return ((void *)0);
}

static void dict_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    mp_obj_dict_t *self = ((void *)(self_in));
    _Bool first = 1;
    const char *item_separator = ", ";
    const char *key_separator = ": ";
    if (!(((((10)) >= (30))) && kind == PRINT_JSON)) {
        kind = PRINT_REPR;
    } else {
        
        item_separator = ((mp_print_ext_t *)print)->item_separator;
        key_separator = ((mp_print_ext_t *)print)->key_separator;
        #line 85 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
    }
    if (((((10)) >= (30))) && self->base.type != &mp_type_dict && kind != PRINT_JSON) {
        mp_printf(print, "%q(", (qstr)self->base.type->name);
    }
    mp_print_str(print, "{");
    size_t cur = 0;
    mp_map_elem_t *next = ((void *)0);
    while ((next = dict_iter_next(self, &cur)) != ((void *)0)) {
        if (!first) {
            mp_print_str(print, item_separator);
        }
        first = 0;
        _Bool add_quote = ((((10)) >= (30))) && kind == PRINT_JSON && !(mp_obj_is_qstr(next->key) || (mp_obj_is_obj(next->key) && ((mp_binary_op_fun_t)(((((mp_obj_base_t *)((void *)(next->key)))->type)->slot_index_binary_op) ? ((mp_binary_op_fun_t)(((mp_obj_base_t *)((void *)(next->key)))->type)->slots[(((mp_obj_base_t *)((void *)(next->key)))->type)->slot_index_binary_op - 1]) : ((void *)0))) == mp_obj_str_binary_op));
        if (add_quote) {
            mp_print_str(print, "\"");
        }
...
mp_obj_t mp_obj_dict_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    mp_obj_dict_t *dict = ((void *)(dict_out));
    dict->base.type = type;
    



#line 123 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
    if (n_args > 0 || n_kw > 0) {
...
static mp_obj_t dict_unary_op(mp_unary_op_t op, mp_obj_t self_in) {
    ...
    switch (op) {
        ...
        case MP_UNARY_OP_LEN:
            return ((mp_obj_t)((((mp_uint_t)(self->map.used)) << 1) | 1));
        




#line 145 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
        default:
            return (((mp_obj_t)((void *)0)));      
    }
}
...
static mp_obj_t dict_binary_op(mp_binary_op_t op, mp_obj_t lhs_in, mp_obj_t rhs_in) {
    mp_obj_dict_t *o = ((void *)(lhs_in));
    switch (op) {
        case MP_BINARY_OP_CONTAINS: {
            mp_map_elem_t *elem = mp_map_lookup(&o->map, rhs_in, MP_MAP_LOOKUP);
            return mp_obj_new_bool(elem != ((void *)0));
        }
...
#line 172 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"

            if ((( ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_bool)) || (_wassert(L"(&mp_type_dict) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(173)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_int)) || (_wassert(L"(&mp_type_dict) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(173)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_str)) || (_wassert(L"(&mp_type_dict) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(173)), 0)) ), ((void)1), ((void)( (!!((&mp_type_dict) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_dict) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(173)), 0)) ), 1) && (mp_obj_is_obj(rhs_in) && (((mp_obj_base_t *)((void *)(rhs_in)))->type == (&mp_type_dict))))) {
                mp_obj_dict_t *rhs = ((void *)(rhs_in));
                ...
                size_t cur = 0;
                mp_map_elem_t *next = ((void *)0);
                while ((next = dict_iter_next(o, &cur)) != ((void *)0)) {
                    mp_map_elem_t *elem = mp_map_lookup(&rhs->map, next->key, MP_MAP_LOOKUP);
                    if (elem == ((void *)0) || !mp_obj_equal(next->value, elem->value)) {
                        return ((mp_obj_t)(((1) << 3) | 6));
                    }
                }
        ...
        case MP_BINARY_OP_OR: {
            ...
            dict_update(2, dicts, (mp_map_t *)&(mp_const_empty_dict_obj.map));
            return lhs_in;
        }
        #line 204 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
        default:
...
static const mp_obj_fun_builtin_fixed_t dict_clear_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = dict_clear}};

mp_obj_t mp_obj_dict_copy(mp_obj_t self_in) {
    ;
    mp_obj_dict_t *self = ((void *)(self_in));
    mp_obj_t other_out = mp_obj_new_dict(self->map.alloc);
    mp_obj_dict_t *other = ((void *)(other_out));
...
static const mp_obj_fun_builtin_fixed_t dict_copy_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = mp_obj_dict_copy}};



static mp_obj_t dict_fromkeys(size_t n_args, const mp_obj_t *args) {
    mp_obj_t iter = mp_getiter(args[1], ((void *)0));
    mp_obj_t value = ((mp_obj_t)(((0) << 3) | 6));
    mp_obj_t next = (((mp_obj_t)((void *)0)));
    ...
    if (len == (((mp_obj_t)((void *)0)))) {
        ...
        self_out = mp_obj_new_dict((((mp_int_t)(len)) >> 1));
    }

    mp_obj_dict_t *self = ((void *)(self_out));
    while ((next = mp_iternext(iter)) != (((mp_obj_t)((void *)0)))) {
        mp_map_lookup(&self->map, next, MP_MAP_LOOKUP_ADD_IF_NOT_FOUND)->value = value;
    }

    return self_out;
}
static const mp_obj_fun_builtin_var_t dict_fromkeys_fun_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = dict_fromkeys}};
static const mp_rom_obj_static_class_method_t dict_fromkeys_obj = {{&mp_type_classmethod}, (&dict_fromkeys_fun_obj)};
#line 308 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"

static mp_obj_t dict_get_helper(size_t n_args, const mp_obj_t *args, mp_map_lookup_kind_t lookup_kind) {
    ;
    mp_obj_dict_t *self = ((void *)(args[0]));
    if (lookup_kind != MP_MAP_LOOKUP) {
        mp_ensure_not_fixed(self);
    }
    mp_map_elem_t *elem = mp_map_lookup(&self->map, args[1], lookup_kind);
    mp_obj_t value;
    if (elem == ((void *)0) || elem->value == (((mp_obj_t)((void *)0)))) {
        if (n_args == 2) {
            if (lookup_kind == MP_MAP_LOOKUP_REMOVE_IF_FOUND) {
                mp_raise_type_arg(&mp_type_KeyError, args[1]);
            } else {
                value = ((mp_obj_t)(((0) << 3) | 6));
            }
        } else {
            value = args[2];
        }
...
static const mp_obj_fun_builtin_var_t dict_get_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = dict_get}};
...
static const mp_obj_fun_builtin_var_t dict_pop_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = dict_pop}};
...
static const mp_obj_fun_builtin_var_t dict_setdefault_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(2)) << 17) | (((uint32_t)(3)) << 1) | ((0) ? 1 : 0))), .fun = {.var = dict_setdefault}};
...
static mp_obj_t dict_popitem(mp_obj_t self_in) {
    ...
    mp_ensure_not_fixed(self);
    if (self->map.used == 0) {
        mp_raise_msg(&mp_type_KeyError, (mp_rom_error_text_t)"popitem(): dictionary is empty");
    }
    size_t cur = 0;
...
#line 367 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
    mp_map_elem_t *next = dict_iter_next(self, &cur);
    ((void)( (!!(next)) || (_wassert(L"next", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(368)), 0)) );
    self->map.used--;
    mp_obj_t items[] = {next->key, next->value};
    next->key = (((mp_obj_t)((void *)4))); 
    next->value = (((mp_obj_t)((void *)0)));
    mp_obj_t tuple = mp_obj_new_tuple(2, items);

    return tuple;
}
static const mp_obj_fun_builtin_fixed_t dict_popitem_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = dict_popitem}};
...
static mp_obj_t dict_update(size_t n_args, const mp_obj_t *args, mp_map_t *kwargs) {
    ...
    mp_arg_check_num(n_args, kwargs->used, 1, 2, 1);
    ...
    if (n_args == 2) {
        ...
        if (mp_obj_is_dict_or_ordereddict(args[1])) {
            ...
            if (args[1] != args[0]) {
                size_t cur = 0;
                mp_map_elem_t *elem = ((void *)0);
                while ((elem = dict_iter_next((mp_obj_dict_t *)((void *)(args[1])), &cur)) != ((void *)0)) {
            ...
            mp_obj_t next = (((mp_obj_t)((void *)0)));
            while ((next = mp_iternext(iter)) != (((mp_obj_t)((void *)0)))) {
                mp_obj_t inneriter = mp_getiter(next, ((void *)0));
                mp_obj_t key = mp_iternext(inneriter);
                mp_obj_t value = mp_iternext(inneriter);
                mp_obj_t stop = mp_iternext(inneriter);
                if (key == (((mp_obj_t)((void *)0)))
                    || value == (((mp_obj_t)((void *)0)))
                    || stop != (((mp_obj_t)((void *)0)))) {
                    mp_raise_ValueError((mp_rom_error_text_t)"dict update sequence has wrong length");
                } else {
...
static const mp_obj_fun_builtin_var_t dict_update_obj = {.base = {.type = &mp_type_fun_builtin_var}, .sig = ((uint32_t)((((uint32_t)(1)) << 17) | (((uint32_t)((0xffff))) << 1) | ((1) ? 1 : 0))), .fun = {.kw = dict_update}};
...
static mp_obj_t dict_view_it_iternext(mp_obj_t self_in) {
    ;
    mp_obj_dict_view_it_t *self = ((void *)(self_in));
    mp_map_elem_t *next = dict_iter_next(((void *)(self->dict)), &self->cur);
...
static const mp_obj_type_t mp_type_dict_view_it = { .base = { &mp_type_type }, .flags = (0x0080), .name = MP_QSTR_iterator, .slot_index_iter = 1, .slots = { dict_view_it_iternext, } };
#line 485 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"

static mp_obj_t dict_view_getiter(mp_obj_t view_in, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_dict_view_it_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_dict_view_it_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(487)), 0)) );
    ;
    mp_obj_dict_view_t *view = ((void *)(view_in));
...
static void dict_view_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    (void)kind;
    ;
    mp_obj_dict_view_t *self = ((void *)(self_in));
    _Bool first = 1;
    ...
    mp_obj_t next = (((mp_obj_t)((void *)0)));
    while ((next = dict_view_it_iternext(self_iter)) != (((mp_obj_t)((void *)0)))) {
        if (!first) {
            mp_print_str(print, ", ");
        }
        first = 0;
...
static mp_obj_t dict_view_unary_op(mp_unary_op_t op, mp_obj_t o_in) {
    mp_obj_dict_view_t *o = ((void *)(o_in));
    
    if (op == MP_UNARY_OP_HASH && o->kind == MP_DICT_VIEW_VALUES) {
        return ((mp_obj_t)((((mp_uint_t)((mp_uint_t)o_in)) << 1) | 1));
    }
...
static mp_obj_t dict_view_binary_op(mp_binary_op_t op, mp_obj_t lhs_in, mp_obj_t rhs_in) {
    ...
    mp_obj_dict_view_t *o = ((void *)(lhs_in));
...
static const mp_obj_type_t mp_type_dict_view = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_dict_view, .slot_index_print = 1, .slot_index_unary_op = 2, .slot_index_binary_op = 3, .slot_index_iter = 4, .slots = { dict_view_print, dict_view_unary_op, dict_view_binary_op, dict_view_getiter, } };
#line 549 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"

static mp_obj_t mp_obj_new_dict_view(mp_obj_t dict, mp_dict_view_kind_t kind) {
    mp_obj_dict_view_t *o = ((mp_obj_dict_view_t *)mp_obj_malloc_helper(sizeof(mp_obj_dict_view_t), &mp_type_dict_view));
    o->dict = dict;
    o->kind = kind;
    return ((mp_obj_t)(o));
}
...
static const mp_obj_fun_builtin_fixed_t dict_items_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = dict_items}};

static mp_obj_t dict_keys(mp_obj_t self_in) {
    return dict_view(self_in, MP_DICT_VIEW_KEYS);
}
static const mp_obj_fun_builtin_fixed_t dict_keys_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = dict_keys}};

static mp_obj_t dict_values(mp_obj_t self_in) {
    return dict_view(self_in, MP_DICT_VIEW_VALUES);
}
static const mp_obj_fun_builtin_fixed_t dict_values_obj = {.base = {.type = &mp_type_fun_builtin_1}, .fun = {._1 = dict_values}};




static mp_obj_t dict_getiter(mp_obj_t self_in, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_dict_view_it_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_dict_view_it_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objdict.c", (unsigned)(581)), 0)) );
    ;
    mp_obj_dict_view_it_t *o = (mp_obj_dict_view_it_t *)iter_buf;
    o->base.type = &mp_type_dict_view_it;
...
static const mp_rom_map_elem_t dict_locals_dict_table[] = {
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_clear)) << 3) | 2)), (&dict_clear_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_copy)) << 3) | 2)), (&dict_copy_obj) },
    
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_fromkeys)) << 3) | 2)), (&dict_fromkeys_obj) },
    #line 600 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_get)) << 3) | 2)), (&dict_get_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_items)) << 3) | 2)), (&dict_items_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_keys)) << 3) | 2)), (&dict_keys_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_pop)) << 3) | 2)), (&dict_pop_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_popitem)) << 3) | 2)), (&dict_popitem_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_setdefault)) << 3) | 2)), (&dict_setdefault_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_update)) << 3) | 2)), (&dict_update_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR_values)) << 3) | 2)), (&dict_values_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___getitem__)) << 3) | 2)), (&mp_op_getitem_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___setitem__)) << 3) | 2)), (&mp_op_setitem_obj) },
    { ((mp_obj_t)((((mp_uint_t)(MP_QSTR___delitem__)) << 3) | 2)), (&mp_op_delitem_obj) },
};
...
const mp_obj_type_t mp_type_dict = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_dict, .slot_index_make_new = 1, .slot_index_print = 2, .slot_index_unary_op = 3, .slot_index_binary_op = 4, .slot_index_subscr = 5, .slot_index_iter = 6, .slot_index_locals_dict = 7, .slots = { mp_obj_dict_make_new, dict_print, dict_unary_op, dict_binary_op, dict_subscr, dict_getiter, &dict_locals_dict, } };
#line 627 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
#line 643 "E:\\Work\\code\\opensource\\micropython\\py\\objdict.c"
...
mp_obj_t mp_obj_new_dict(size_t n_args) {
    mp_obj_dict_t *o = (((mp_obj_dict_t *)(m_malloc(sizeof(mp_obj_dict_t) * (1)))));
