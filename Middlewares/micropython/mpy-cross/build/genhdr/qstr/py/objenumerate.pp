#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"
...
static mp_obj_t enumerate_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args) {
    ...
    static const mp_arg_t allowed_args[] = {
        { MP_QSTR_iterable, MP_ARG_REQUIRED | MP_ARG_OBJ, {.u_obj = (((mp_obj_t)((void *)0)))} },
    ...
    mp_arg_parse_all_kw_array(n_args, n_kw, args,
        (sizeof(allowed_args) / sizeof((allowed_args)[0])), allowed_args, (mp_arg_val_t *)&arg_vals);

    
    mp_obj_enumerate_t *o = ((mp_obj_enumerate_t *)mp_obj_malloc_helper(sizeof(mp_obj_enumerate_t), type));
    o->iter = mp_getiter(arg_vals.iterable.u_obj, ((void *)0));
...
#line 66 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"

    return ((mp_obj_t)(o));
}

const mp_obj_type_t mp_type_enumerate = { .base = { &mp_type_type }, .flags = (0x0080), .name = MP_QSTR_enumerate, .slot_index_make_new = 1, .slot_index_iter = 2, .slots = { enumerate_make_new, enumerate_iternext, } };
#line 77 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"

static mp_obj_t enumerate_iternext(mp_obj_t self_in) {
    ((void)( (!!((( ((void)1), ((void)( (!!((&mp_type_enumerate) != &mp_type_bool)) || (_wassert(L"(&mp_type_enumerate) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c", (unsigned)(79)), 0)) ), ((void)1), ((void)( (!!((&mp_type_enumerate) != &mp_type_int)) || (_wassert(L"(&mp_type_enumerate) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c", (unsigned)(79)), 0)) ), ((void)1), ((void)( (!!((&mp_type_enumerate) != &mp_type_str)) || (_wassert(L"(&mp_type_enumerate) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c", (unsigned)(79)), 0)) ), ((void)1), ((void)( (!!((&mp_type_enumerate) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_enumerate) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c", (unsigned)(79)), 0)) ), 1) && (mp_obj_is_obj(self_in) && (((mp_obj_base_t *)((void *)(self_in)))->type == (&mp_type_enumerate)))))) || (_wassert(L"mp_obj_is_type(self_in, &mp_type_enumerate)", L"E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c", (unsigned)(79)), 0)) );
    mp_obj_enumerate_t *self = ((void *)(self_in));
    mp_obj_t next = mp_iternext(self->iter);
    if (next == (((mp_obj_t)((void *)0)))) {
        return (((mp_obj_t)((void *)0)));
    } else {
        mp_obj_t items[] = {((mp_obj_t)((((mp_uint_t)(self->cur++)) << 1) | 1)), next};
        return mp_obj_new_tuple(2, items);
    }
}

#line 91 "E:\\Work\\code\\opensource\\micropython\\py\\objenumerate.c"
