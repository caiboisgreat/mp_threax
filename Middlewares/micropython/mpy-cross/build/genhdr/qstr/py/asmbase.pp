#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
...
#pragma warning(pop) 
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"



void mp_asm_base_init(mp_asm_base_t *as, size_t max_num_labels) {
    as->max_num_labels = max_num_labels;
    as->label_offsets = ((size_t *)(m_malloc(sizeof(size_t) * (max_num_labels))));
}

void mp_asm_base_deinit(mp_asm_base_t *as, _Bool free_code) {
    if (free_code) {
        ((void)(as->code_size), m_free(as->code_base));
    }
    ((void)(as->max_num_labels), m_free(as->label_offsets));
}
...
void mp_asm_base_start_pass(mp_asm_base_t *as, int pass) {
    if (pass < (2)) {
        ...
        do { *(void **)&as->code_base = ((byte *)(m_malloc(sizeof(byte) * (as->code_offset)))); *&as->code_size = as->code_offset; } while (0);
        ((void)( (!!(as->code_size == 0 || as->code_base != ((void *)0))) || (_wassert(L"as->code_size == 0 || as->code_base != NULL", L"E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c", (unsigned)(56)), 0)) );
    }
    as->pass = pass;
    as->suppress = 0;
    as->code_offset = 0;
...
uint8_t *mp_asm_base_get_cur_to_write_bytes(void *as_in, size_t num_bytes_to_write) {
    ...
    if (as->pass == (2)) {
        ((void)( (!!(as->code_offset + num_bytes_to_write <= as->code_size)) || (_wassert(L"as->code_offset + num_bytes_to_write <= as->code_size", L"E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c", (unsigned)(74)), 0)) );
...
void mp_asm_base_label_assign(mp_asm_base_t *as, size_t label) {
    ((void)( (!!(label < as->max_num_labels)) || (_wassert(L"label < as->max_num_labels", L"E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c", (unsigned)(82)), 0)) );
    ...
    if (as->pass < (2)) {
        ...
        ((void)( (!!(as->label_offsets[label] == (size_t)-1)) || (_wassert(L"as->label_offsets[label] == (size_t)-1", L"E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c", (unsigned)(90)), 0)) );
        as->label_offsets[label] = as->code_offset;
    } else {
        
        ((void)( (!!(as->label_offsets[label] == as->code_offset)) || (_wassert(L"as->label_offsets[label] == as->code_offset", L"E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c", (unsigned)(94)), 0)) );
        
        if (mp_dynamic_compiler.native_arch == MP_NATIVE_ARCH_DEBUG) {
            mp_printf((&mp_stdout_print), "label(label_%u)\n", (unsigned int)label);
        }
        #line 100 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
    }
}
...
#line 120 "E:\\Work\\code\\opensource\\micropython\\py\\asmbase.c"
