#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"
...
#pragma warning(pop) 
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"
...
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"
...
static void singleton_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    (void)kind;
    mp_obj_singleton_t *self = ((void *)(self_in));
    mp_printf(print, "%q", self->name);
}

const mp_obj_type_t mp_type_singleton = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_, .slot_index_print = 1, .slots = { singleton_print, } };
#line 50 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"

const mp_obj_singleton_t mp_const_ellipsis_obj = {{&mp_type_singleton}, MP_QSTR_Ellipsis};


#line 55 "E:\\Work\\code\\opensource\\micropython\\py\\objsingleton.c"
