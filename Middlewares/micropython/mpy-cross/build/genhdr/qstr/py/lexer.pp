#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
static _Bool is_end(mp_lexer_t *lex) {
    return lex->chr0 == ((unichar)((mp_uint_t)(-1)));
}

static _Bool is_physical_newline(mp_lexer_t *lex) {
    return lex->chr0 == '\n';
}

static _Bool is_char(mp_lexer_t *lex, byte c) {
    return lex->chr0 == c;
}

static _Bool is_char_or(mp_lexer_t *lex, byte c1, byte c2) {
    return lex->chr0 == c1 || lex->chr0 == c2;
}

static _Bool is_char_or3(mp_lexer_t *lex, byte c1, byte c2, byte c3) {
    return lex->chr0 == c1 || lex->chr0 == c2 || lex->chr0 == c3;
}


static _Bool is_char_or4(mp_lexer_t *lex, byte c1, byte c2, byte c3, byte c4) {
    return lex->chr0 == c1 || lex->chr0 == c2 || lex->chr0 == c3 || lex->chr0 == c4;
}
#line 70 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"

static _Bool is_char_following(mp_lexer_t *lex, byte c) {
    return lex->chr1 == c;
}

static _Bool is_char_following_or(mp_lexer_t *lex, byte c1, byte c2) {
    return lex->chr1 == c1 || lex->chr1 == c2;
}

static _Bool is_char_following_following_or(mp_lexer_t *lex, byte c1, byte c2) {
    return lex->chr2 == c1 || lex->chr2 == c2;
}

static _Bool is_char_and(mp_lexer_t *lex, byte c1, byte c2) {
    return lex->chr0 == c1 && lex->chr1 == c2;
}

static _Bool is_whitespace(mp_lexer_t *lex) {
    return unichar_isspace(lex->chr0);
}

static _Bool is_letter(mp_lexer_t *lex) {
    return unichar_isalpha(lex->chr0);
}

static _Bool is_digit(mp_lexer_t *lex) {
    return unichar_isdigit(lex->chr0);
}

static _Bool is_following_digit(mp_lexer_t *lex) {
    return unichar_isdigit(lex->chr1);
}

static _Bool is_following_base_char(mp_lexer_t *lex) {
    const unichar chr1 = lex->chr1 | 0x20;
    return chr1 == 'b' || chr1 == 'o' || chr1 == 'x';
}

static _Bool is_following_odigit(mp_lexer_t *lex) {
    return lex->chr1 >= '0' && lex->chr1 <= '7';
}

static _Bool is_string_or_bytes(mp_lexer_t *lex) {
...
#line 121 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
           || ((is_char_and(lex, 'r', 'b') || is_char_and(lex, 'b', 'r'))
               && is_char_following_following_or(lex, '\'', '\"'));
}


static _Bool is_head_of_identifier(mp_lexer_t *lex) {
    return is_letter(lex) || lex->chr0 == '_' || lex->chr0 >= 0x80;
}

static _Bool is_tail_of_identifier(mp_lexer_t *lex) {
...
static void next_char(mp_lexer_t *lex) {
    if (lex->chr0 == '\n') {
        ...
        lex->column = (((lex->column - 1 + (8)) / (8)) * (8)) + 1;
    } else {
    ...
    #line 173 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
    {
    ...
    if (lex->chr2 == ((unichar)((mp_uint_t)(-1))) && lex->chr1 != ((unichar)((mp_uint_t)(-1))) && lex->chr1 != '\n') {
        lex->chr2 = '\n';
    }
}
...
static void indent_push(mp_lexer_t *lex, size_t indent) {
    if (lex->num_indent_level >= lex->alloc_indent_level) {
        lex->indent_level = ((uint16_t *)(m_realloc((lex->indent_level), sizeof(uint16_t) * (lex->alloc_indent_level + (8)))));
        lex->alloc_indent_level += (8);
    }
...
static const char *const tok_kw[] = {
    ...
    "async",
    "await",
    #line 266 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
    "break",
    "class",
    "continue",
    "def",
...
static _Bool get_hex(mp_lexer_t *lex, size_t num_digits, mp_uint_t *result) {
    mp_uint_t num = 0;
    while (num_digits-- != 0) {
        next_char(lex);
        unichar c = ((lex)->chr0);
...
static void parse_string_literal(mp_lexer_t *lex, _Bool is_raw, _Bool is_fstring) {
    ...
    #line 346 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"

    while (!is_end(lex) && (num_quotes > 1 || !is_char(lex, '\n')) && n_closing < num_quotes) {
        if (is_char(lex, quote_char)) {
            n_closing += 1;
            vstr_add_char(&lex->vstr, ((lex)->chr0));
        } else {
            n_closing = 0;
            ...
            #line 411 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
                ...
                if (is_raw) {
                    ...
                    switch (c) {
                        ...
                        case 'N':
                            ...
                            mp_raise_NotImplementedError((mp_rom_error_text_t)"unicode name escapes");
                            break;
                        default:
                            if (c >= '0' && c <= '7') {
...
#line 510 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
                    else {
                ...
                vstr_add_byte(&lex->vstr, ((lex)->chr0));
            }
        }
        next_char(lex);
    }
...
static _Bool skip_whitespace(mp_lexer_t *lex, _Bool stop_at_newline) {
    while (!is_end(lex)) {
...
void mp_lexer_to_next(mp_lexer_t *lex) {
    ...
    #line 578 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
    ...
    _Bool had_physical_newline = skip_whitespace(lex, 1);
    ...
    if (lex->emit_dent < 0) {
        ...
        do {
            ...
            if (is_char(lex, 'u')) {
                ...
                #line 667 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
            }
            ...
            #line 678 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
        ...
        for (size_t i = 0; i < (sizeof(tok_kw) / sizeof((tok_kw)[0])); i++) {
            int cmp = strcmp(s, tok_kw[i]);
            if (cmp == 0) {
                lex->tok_kind = MP_TOKEN_KW_FALSE + i;
                if (lex->tok_kind == MP_TOKEN_KW___DEBUG__) {
                    lex->tok_kind = ((mp_state_ctx.vm.mp_optimise_value) == 0 ? MP_TOKEN_KW_TRUE : MP_TOKEN_KW_FALSE);
                }
                break;
            } else if (cmp < 0) {
        ...
        ((void)sizeof(char[1 - 2 * !(MP_TOKEN_NUMBER_OF <= 256)]));
...
mp_lexer_t *mp_lexer_new(qstr src_name, mp_reader_t reader) {
    mp_lexer_t *lex = (((mp_lexer_t *)(m_malloc(sizeof(mp_lexer_t) * (1)))));
    ...
    lex->alloc_indent_level = (10);
    lex->num_indent_level = 1;
    lex->indent_level = ((uint16_t *)(m_malloc(sizeof(uint16_t) * (lex->alloc_indent_level))));
    vstr_init(&lex->vstr, 32);
    
    vstr_init(&lex->fstring_args, 0);
    lex->fstring_args_idx = 0;
    #line 863 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
#line 910 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"

#line 912 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
...
void mp_lexer_free(mp_lexer_t *lex) {
    if (lex) {
        ...
        #line 920 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
        ((void)(lex->alloc_indent_level), m_free(lex->indent_level));
        (((void)(1), m_free(lex)));
    }
}
...
#line 947 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"

#line 949 "E:\\Work\\code\\opensource\\micropython\\py\\lexer.c"
