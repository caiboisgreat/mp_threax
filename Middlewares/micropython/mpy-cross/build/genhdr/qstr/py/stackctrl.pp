#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"



#line 1 "E:\\Work\\code\\opensource\\micropython\\py/stackctrl.h"
...
#line 51 "E:\\Work\\code\\opensource\\micropython\\py/stackctrl.h"

#line 53 "E:\\Work\\code\\opensource\\micropython\\py/stackctrl.h"

#line 55 "E:\\Work\\code\\opensource\\micropython\\py/stackctrl.h"
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"

void mp_stack_ctrl_init(void) {
    


#line 40 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"
    volatile int stack_dummy;
    (mp_state_ctx.thread.stack_top) = (char *)&stack_dummy;
    

#line 45 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"
}

void mp_stack_set_top(void *top) {
    (mp_state_ctx.thread.stack_top) = top;
}

mp_uint_t mp_stack_usage(void) {
    
    volatile int stack_dummy;
    return (mp_state_ctx.thread.stack_top) - (char *)&stack_dummy;
}



void mp_stack_set_limit(mp_uint_t limit) {
    (mp_state_ctx.thread.stack_limit) = limit;
}

void mp_stack_check(void) {
    if (mp_stack_usage() >= (mp_state_ctx.thread.stack_limit)) {
        mp_raise_recursion_depth();
    }
}

#line 70 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"

#line 72 "E:\\Work\\code\\opensource\\micropython\\py\\stackctrl.c"
