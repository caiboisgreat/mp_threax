#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#pragma warning(pop) 
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
#line 94 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
    if (kind == PRINT_STR) {
...
static mp_obj_t uni_unary_op(mp_unary_op_t op, mp_obj_t self_in) {
    ...
    switch (op) {
        ...
        case MP_UNARY_OP_LEN:
            return ((mp_obj_t)((((mp_uint_t)(utf8_charlen(str_data, str_len))) << 1) | 1));
        default:
            return (((mp_obj_t)((void *)0))); 
    }
}
...
const byte *str_index_to_ptr(const mp_obj_type_t *type, const byte *self_data, size_t self_len,
    ...
    if (type == &mp_type_bytes
        ...
        #line 123 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
        ) {
    ...
    if (mp_obj_is_small_int(index)) {
        ...
        mp_raise_msg_varg(&mp_type_TypeError, (mp_rom_error_text_t)"string indices must be integers, not %s", mp_obj_get_type_str(index));
    }
    ...
    if (i < 0) {
        ...
        for (s = top - 1; i; --s) {
            if (s < self_data) {
                ...
                mp_raise_msg(&mp_type_IndexError, (mp_rom_error_text_t)"string index out of range");
            }
            if (!(((*s) & 0xC0) == 0x80)) {
                ++i;
            }
...
static mp_obj_t str_subscr(mp_obj_t self_in, mp_obj_t index, mp_obj_t value) {
    ...
    ((void)( (!!(type == &mp_type_str)) || (_wassert(L"type == &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(183)), 0)) );
    ...
    if (value == (((mp_obj_t)((void *)4)))) {
        ...
        if ((( ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_bool)) || (_wassert(L"(&mp_type_slice) != &mp_type_bool", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(188)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_int)) || (_wassert(L"(&mp_type_slice) != &mp_type_int", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(188)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_str)) || (_wassert(L"(&mp_type_slice) != &mp_type_str", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(188)), 0)) ), ((void)1), ((void)( (!!((&mp_type_slice) != &mp_type_NoneType)) || (_wassert(L"(&mp_type_slice) != &mp_type_NoneType", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(188)), 0)) ), 1) && (mp_obj_is_obj(index) && (((mp_obj_base_t *)((void *)(index)))->type == (&mp_type_slice))))) {
            mp_obj_t ostart, ostop, ostep;
            mp_obj_slice_t *slice = ((void *)(index));
            ostart = slice->start;
            ostop = slice->stop;
            ostep = slice->step;

            if (ostep != ((mp_obj_t)(((0) << 3) | 6)) && ostep != ((mp_obj_t)((((mp_uint_t)(1)) << 1) | 1))) {
                mp_raise_NotImplementedError((mp_rom_error_text_t)"only slices with step=1 (aka None) are supported");
            }

            const byte *pstart, *pstop;
            if (ostart != ((mp_obj_t)(((0) << 3) | 6))) {
                pstart = str_index_to_ptr(type, self_data, self_len, ostart, 1);
            } else {
                pstart = self_data;
            }
            if (ostop != ((mp_obj_t)(((0) << 3) | 6))) {
                
                
                pstop = str_index_to_ptr(type, self_data, self_len, ostop, 1);
            } else {
        ...
        #line 218 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
        const byte *s = str_index_to_ptr(type, self_data, self_len, index, 0);
        int len = 1;
        if (((*s) & 0x80)) {
...
const mp_obj_type_t mp_type_str = { .base = { &mp_type_type }, .flags = (0x0000), .name = MP_QSTR_str, .slot_index_make_new = 1, .slot_index_print = 2, .slot_index_unary_op = 3, .slot_index_binary_op = 4, .slot_index_subscr = 5, .slot_index_iter = 6, .slot_index_buffer = 7, .slot_index_locals_dict = 8, .slots = { mp_obj_str_make_new, uni_print, uni_unary_op, mp_obj_str_binary_op, str_subscr, mp_obj_new_str_iterator, mp_obj_str_get_buffer, &mp_obj_str_locals_dict, } };
#line 245 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
...
static mp_obj_t mp_obj_new_str_iterator(mp_obj_t str, mp_obj_iter_buf_t *iter_buf) {
    ((void)( (!!(sizeof(mp_obj_str_it_t) <= sizeof(mp_obj_iter_buf_t))) || (_wassert(L"sizeof(mp_obj_str_it_t) <= sizeof(mp_obj_iter_buf_t)", L"E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c", (unsigned)(271)), 0)) );
...
#line 281 "E:\\Work\\code\\opensource\\micropython\\py\\objstrunicode.c"
