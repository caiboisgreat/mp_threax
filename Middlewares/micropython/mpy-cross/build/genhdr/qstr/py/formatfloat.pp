#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#pragma warning(pop) 
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 36 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 37 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 57 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"

#line 59 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"





#line 65 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"

static __inline int fp_expval(mp_float_t x) {
    mp_float_union_t fb = { x };
    return (int)fb.p.exp - (1023);
}



static __inline int fp_isless1(mp_float_t x) {
    return x < 1.0;
}

static __inline int fp_iszero(mp_float_t x) {
    return x == 0.0;
}
...
#line 86 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
static __inline mp_float_t fp_diff(mp_float_t x, mp_float_t y) {
    return x - y;
}
#line 90 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
#line 135 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"





#line 141 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"



#line 145 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
...
static int mp_format_mantissa(mp_large_float_uint_t mantissa, mp_large_float_uint_t mantissa_cap, char *buf, char *s,
    ...
    if (mantissa) {
        ...
        if (mantissa >= mantissa_cap) {
            if (fmt_flags & 0x04) {
                ((void)( (!!(e >= 0)) || (_wassert(L"e >= 0", L"E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c", (unsigned)(172)), 0)) );
                num_digits++;
                dec++;
            } else {
                mantissa /= 10;
...
#line 227 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
    ...
    if (((e != 0) || (fmt_flags & 0x01)) && !(fmt_flags & 0x04)) {
        *s++ = 'E' | (fmt_flags & 0x20);
        if (e >= 0) {
            *s++ = '+';
        } else {
...
int mp_format_float(mp_float_t f_entry, char *buf_entry, size_t buf_size, char fmt, int prec, char sign) {
    ((void)( (!!(buf_size >= ((19) + 10))) || (_wassert(L"buf_size >= MIN_BUF_SIZE", L"E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c", (unsigned)(276)), 0)) );

    
    mp_float_t f = f_entry;
    char *buf = buf_entry;
    if (((__pragma(warning(suppress:6334))(sizeof ((f_entry) + (float)0) == sizeof (float) ? 'f' : sizeof ((f_entry) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdsign((float)(f_entry)) : __pragma(warning(suppress:6334))(sizeof ((f_entry) + (float)0) == sizeof (float) ? 'f' : sizeof ((f_entry) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dsign((double)(f_entry)) : _ldsign((long double)(f_entry)))) && !(((__pragma(warning(suppress:6334))(sizeof ((f_entry) + (float)0) == sizeof (float) ? 'f' : sizeof ((f_entry) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdclass((float)(f_entry)) : __pragma(warning(suppress:6334))(sizeof ((f_entry) + (float)0) == sizeof (float) ? 'f' : sizeof ((f_entry) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dclass((double)(f_entry)) : _ldclass((long double)(f_entry)))) == 2)) {
        f = -f;
        sign = '-';
    }
    if (sign) {
    ...
    {
        char *s = buf;
        if ((((__pragma(warning(suppress:6334))(sizeof ((f) + (float)0) == sizeof (float) ? 'f' : sizeof ((f) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdclass((float)(f)) : __pragma(warning(suppress:6334))(sizeof ((f) + (float)0) == sizeof (float) ? 'f' : sizeof ((f) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dclass((double)(f)) : _ldclass((long double)(f)))) == 1)) {
            *s++ = 'I' ^ uc;
            *s++ = 'N' ^ uc;
            *s++ = 'F' ^ uc;
            goto ret;
        } else if ((((__pragma(warning(suppress:6334))(sizeof ((f) + (float)0) == sizeof (float) ? 'f' : sizeof ((f) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdclass((float)(f)) : __pragma(warning(suppress:6334))(sizeof ((f) + (float)0) == sizeof (float) ? 'f' : sizeof ((f) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dclass((double)(f)) : _ldclass((long double)(f)))) == 2)) {
            *s++ = 'N' ^ uc;
            *s++ = 'A' ^ uc;
            *s++ = 'N' ^ uc;
        ret:
    ...
    int fmt_flags = (unsigned char)uc;  
    char lofmt = (char)(fmt | 0x20);  
    if (lofmt == 'f') {
        fmt_flags |= 0x04;
    } else if (lofmt == 'g') {
        fmt_flags |= 0x02;
    ...
    if (!fp_iszero(f)) {
        ...
        e = (int)(fp_expval(f) * 0.3010299956639812);  
    ...
    if (fmt_flags & 0x04) {
        ...
        if (!(fmt_flags & 0x02) || max_digits == 0) {
            max_digits++;
        }
    }
    if (max_digits > (19)) {
        
        trail_zeros = max_digits - (19);
        max_digits = (19);
    }
    int overhead = (fmt_flags & 0x04 ? 3 : 7 + 1);
    ...
    int num_digits = ((16) < max_digits ? (16) : max_digits);
try_again:
    ;
    ...
    ;
#line 440 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
    ...
    if (sizeof(mp_large_float_t) == sizeof(mp_float_t) && num_digits > (16) && decexp > 1) {
        
        if (num_digits > (16) + 1 && decexp > 2) {
            mantissa = 100;
            decexp -= 2;
        } else {
            mantissa = 10;
    ...
    ((void)( (!!(reprlen + 1 <= (int)buf_size)) || (_wassert(L"reprlen + 1 <= (int)buf_size", L"E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c", (unsigned)(470)), 0)) );
...
#line 489 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
    ...
    if (fp_iszero(diff)) {
        ...
        if (num_digits > (16)) {
            err_range <<= 3 * (num_digits - (16));
        }
        int maxruns = 3 + 3 * ((19) - (16));
        while (maxruns-- > 0) {
            
            if (((__pragma(warning(suppress:6334))(sizeof ((diff) + (float)0) == sizeof (float) ? 'f' : sizeof ((diff) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdsign((float)(diff)) : __pragma(warning(suppress:6334))(sizeof ((diff) + (float)0) == sizeof (float) ? 'f' : sizeof ((diff) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dsign((double)(diff)) : _ldsign((long double)(diff))))) {
                mantissa += err_range;
            } else {
                
                ((void)( (!!(mantissa >= err_range)) || (_wassert(L"mantissa >= err_range", L"E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c", (unsigned)(518)), 0)) );
                mantissa -= err_range;
            }
            
            reprlen = mp_format_mantissa(mantissa, mantissa_cap, buf, s, num_digits, max_exp_zeros, extra_zeros, dec, e, fmt_flags);
            ((void)( (!!(reprlen + 1 <= (int)buf_size)) || (_wassert(L"reprlen + 1 <= (int)buf_size", L"E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c", (unsigned)(523)), 0)) );
            ;
            mp_parse_float_internal(buf, reprlen, &check);
            ;
            ...
            mp_float_t delta = fabs(diff) - fabs(best_diff);
            if (((__pragma(warning(suppress:6334))(sizeof ((delta) + (float)0) == sizeof (float) ? 'f' : sizeof ((delta) + (double)0) == sizeof (double) ? 'd' : 'l') == 'f' ? _fdsign((float)(delta)) : __pragma(warning(suppress:6334))(sizeof ((delta) + (float)0) == sizeof (float) ? 'f' : sizeof ((delta) + (double)0) == sizeof (double) ? 'd' : 'l') == 'd' ? _dsign((double)(delta)) : _ldsign((long double)(delta)))) || (fp_iszero(delta) && !(mantissa % 10u))) {
                best_diff = diff;
    ...
    #line 565 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"

    return buf + reprlen - buf_entry;
}

#line 570 "E:\\Work\\code\\opensource\\micropython\\py\\formatfloat.c"
