#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#pragma warning(pop) 
#line 31 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 33 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"



#line 39 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"


#line 42 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 61 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"

#line 63 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
static size_t get_hash_alloc_greater_or_equal_to(size_t x) {
    for (size_t i = 0; i < (sizeof(hash_allocation_sizes) / sizeof((hash_allocation_sizes)[0])); i++) {
...
void mp_map_init(mp_map_t *map, size_t n) {
    if (n == 0) {
        ...
        map->alloc = n;
        map->table = ((mp_map_elem_t *)(m_malloc0(sizeof(mp_map_elem_t) * (map->alloc))));
    }
    map->used = 0;
...
void mp_map_deinit(mp_map_t *map) {
    if (!map->is_fixed) {
        ((void)(map->alloc), m_free(map->table));
    }
...
static void mp_map_rehash(mp_map_t *map) {
    ...
    mp_map_elem_t *new_table = ((mp_map_elem_t *)(m_malloc0(sizeof(mp_map_elem_t) * (new_alloc))));
    ...
    for (size_t i = 0; i < old_alloc; i++) {
        if (old_table[i].key != (((mp_obj_t)((void *)0))) && old_table[i].key != (((mp_obj_t)((void *)4)))) {
            mp_map_lookup(map, old_table[i].key, MP_MAP_LOOKUP_ADD_IF_NOT_FOUND)->value = old_table[i].value;
        }
    }
    ((void)(old_alloc), m_free(old_table));
}
...
mp_map_elem_t *mp_map_lookup(mp_map_t * map, mp_obj_t index, mp_map_lookup_kind_t lookup_kind) {
    ...
    ((void)( (!!(!map->is_fixed || lookup_kind == MP_MAP_LOOKUP)) || (_wassert(L"!map->is_fixed || lookup_kind == MP_MAP_LOOKUP", L"E:\\Work\\code\\opensource\\micropython\\py\\map.c", (unsigned)(158)), 0)) );
...
#line 171 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"

    
    _Bool compare_only_ptrs = map->all_keys_are_qstrs;
    if (compare_only_ptrs) {
        if (mp_obj_is_qstr(index)) {
            
        } else if ((mp_obj_is_obj(index) && (((mp_obj_base_t *)((void *)(index)))->type == (&mp_type_str)))) {
...
#line 208 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
                ;
                return elem;
            }
        }
...
#line 230 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
        return ((void *)0);
        #line 232 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
    }
    ...
    mp_uint_t hash;
    if (mp_obj_is_qstr(index)) {
        hash = qstr_hash((((mp_uint_t)(index)) >> 3));
    } else {
        hash = (((mp_int_t)(mp_unary_op(MP_UNARY_OP_HASH, index))) >> 1);
    }

    size_t pos = hash % map->alloc;
    size_t start_pos = pos;
    mp_map_elem_t *avail_slot = ((void *)0);
    for (;;) {
        mp_map_elem_t *slot = &map->table[pos];
        if (slot->key == (((mp_obj_t)((void *)0)))) {
            
            if (lookup_kind == MP_MAP_LOOKUP_ADD_IF_NOT_FOUND) {
                map->used += 1;
                if (avail_slot == ((void *)0)) {
                    avail_slot = slot;
                }
                avail_slot->key = index;
                avail_slot->value = (((mp_obj_t)((void *)0)));
                if (!mp_obj_is_qstr(index)) {
        ...
        } else if (slot->key == (((mp_obj_t)((void *)4)))) {
            ...
            if (lookup_kind == MP_MAP_LOOKUP_REMOVE_IF_FOUND) {
                ...
                map->used--;
                if (map->table[(pos + 1) % map->alloc].key == (((mp_obj_t)((void *)0)))) {
                    
                    slot->key = (((mp_obj_t)((void *)0)));
                } else {
                    slot->key = (((mp_obj_t)((void *)4)));
                }
...
void mp_set_init(mp_set_t *set, size_t n) {
    set->alloc = n;
    set->used = 0;
    set->table = ((mp_obj_t *)(m_malloc0(sizeof(mp_obj_t) * (set->alloc))));
}
...
static void mp_set_rehash(mp_set_t *set) {
    ...
    set->table = ((mp_obj_t *)(m_malloc0(sizeof(mp_obj_t) * (set->alloc))));
    for (size_t i = 0; i < old_alloc; i++) {
        if (old_table[i] != (((mp_obj_t)((void *)0))) && old_table[i] != (((mp_obj_t)((void *)4)))) {
...
mp_obj_t mp_set_lookup(mp_set_t *set, mp_obj_t index, mp_map_lookup_kind_t lookup_kind) {
    ...
    mp_uint_t hash = (((mp_int_t)(mp_unary_op(MP_UNARY_OP_HASH, index))) >> 1);
    size_t pos = hash % set->alloc;
    size_t start_pos = pos;
    mp_obj_t *avail_slot = ((void *)0);
    for (;;) {
        mp_obj_t elem = set->table[pos];
        if (elem == (((mp_obj_t)((void *)0)))) {
            ...
            if (lookup_kind & MP_MAP_LOOKUP_REMOVE_IF_FOUND) {
                ...
                set->used--;
                if (set->table[(pos + 1) % set->alloc] == (((mp_obj_t)((void *)0)))) {
                    
                    set->table[pos] = (((mp_obj_t)((void *)0)));
                } else {
                    set->table[pos] = (((mp_obj_t)((void *)4)));
                }
            }
            return elem;
        }
...
void mp_set_clear(mp_set_t *set) {
    ((void)(set->alloc), m_free(set->table));
    set->alloc = 0;
    set->used = 0;
    set->table = ((void *)0);
}

#line 448 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
...
#line 462 "E:\\Work\\code\\opensource\\micropython\\py\\map.c"
