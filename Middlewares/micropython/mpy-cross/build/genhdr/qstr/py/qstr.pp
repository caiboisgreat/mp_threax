#line 1 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#pragma warning(pop) 
#line 28 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 29 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 30 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 32 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 34 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 35 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"



#line 39 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"

#line 41 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 50 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"




#line 55 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"


#line 58 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 95 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
const qstr_pool_t mp_qstr_const_pool_static = {
    ...
    #line 115 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 140 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
const qstr_pool_t mp_qstr_const_pool = {
    ...
    #line 160 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 180 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 188 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
}

static const qstr_pool_t *find_qstr(qstr *q) {
    
    
    const qstr_pool_t *pool = (mp_state_ctx.vm.last_pool);
    while (*q < pool->total_prev_len) {
        pool = pool->prev;
    }
    *q -= pool->total_prev_len;
    ((void)( (!!(*q < pool->len)) || (_wassert(L"*q < pool->len", L"E:\\Work\\code\\opensource\\micropython\\py\\qstr.c", (unsigned)(198)), 0)) );
    return pool;
}
...
#line 210 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"

    
    if ((mp_state_ctx.vm.last_pool)->len >= (mp_state_ctx.vm.last_pool)->alloc) {
        size_t new_alloc = (mp_state_ctx.vm.last_pool)->alloc * 2;
        ...
        mp_uint_t pool_size = sizeof(qstr_pool_t)
            + (sizeof(const char *)
                ...
                + sizeof(qstr_hash_t)
                #line 223 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 241 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
    ...
    mp_uint_t at = (mp_state_ctx.vm.last_pool)->len;
    
    (mp_state_ctx.vm.last_pool)->hashes[at] = hash;
    #line 254 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
    (mp_state_ctx.vm.last_pool)->lengths[at] = len;
    (mp_state_ctx.vm.last_pool)->qstrs[at] = q_ptr;
    (mp_state_ctx.vm.last_pool)->len++;

    
    return (mp_state_ctx.vm.last_pool)->total_prev_len + at;
}
...
qstr qstr_find_strn(const char *str, size_t str_len) {
    ...
    #line 272 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"

    
    for (const qstr_pool_t *pool = (mp_state_ctx.vm.last_pool); pool != ((void *)0); pool = pool->prev) {
        size_t low = 0;
        ...
        for (mp_uint_t at = low; at < high + 1; at++) {
            if (
                ...
                #line 297 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
static qstr qstr_from_strn_helper(const char *str, size_t len, _Bool data_is_static) {
    ;
    ...
    if (q == 0) {
        ...
        if (len >= (1 << (8 * (1)))) {
            ;
            mp_raise_msg(&mp_type_RuntimeError, (mp_rom_error_text_t)"name too long");
        }

        if (data_is_static) {
            
            ((void)( (!!(str[len] == '\0')) || (_wassert(L"str[len] == '\\0'", L"E:\\Work\\code\\opensource\\micropython\\py\\qstr.c", (unsigned)(326)), 0)) );
            goto add;
        }
        ...
        if ((mp_state_ctx.vm.qstr_last_chunk) != ((void *)0) && (mp_state_ctx.vm.qstr_last_used) + n_bytes > (mp_state_ctx.vm.qstr_last_alloc)) {
            ...
            char *new_p = ((char *)(m_realloc_maybe(((mp_state_ctx.vm.qstr_last_chunk)), sizeof(char) * ((mp_state_ctx.vm.qstr_last_alloc) + n_bytes), (0))));
            if (new_p == ((void *)0)) {
                
                (void)((char *)(m_realloc_maybe(((mp_state_ctx.vm.qstr_last_chunk)), sizeof(char) * ((mp_state_ctx.vm.qstr_last_used)), (0))));
                (mp_state_ctx.vm.qstr_last_chunk) = ((void *)0);
            } else {
        ...
        if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {
            ...
            (mp_state_ctx.vm.qstr_last_chunk) = ((char *)(m_malloc_maybe(sizeof(char) * (al))));
            if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {
                
                (mp_state_ctx.vm.qstr_last_chunk) = ((char *)(m_malloc_maybe(sizeof(char) * (n_bytes))));
                if ((mp_state_ctx.vm.qstr_last_chunk) == ((void *)0)) {
                    ;
        ...
        char *q_ptr = (mp_state_ctx.vm.qstr_last_chunk) + (mp_state_ctx.vm.qstr_last_used);
...
qstr qstr_from_strn(const char *str, size_t len) {
    return qstr_from_strn_helper(str, len, 0);
}
...
#line 392 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 400 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
}
...
void qstr_pool_info(size_t *n_pool, size_t *n_qstr, size_t *n_str_data_bytes, size_t *n_total_bytes) {
    ...
    *n_str_data_bytes = 0;
    *n_total_bytes = 0;
    for (const qstr_pool_t *pool = (mp_state_ctx.vm.last_pool); pool != ((void *)0) && pool != &mp_qstr_const_pool; pool = pool->prev) {
        *n_pool += 1;
        *n_qstr += pool->len;
...
#line 440 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
    }
...
#line 456 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
...
#line 531 "E:\\Work\\code\\opensource\\micropython\\py\\qstr.c"
